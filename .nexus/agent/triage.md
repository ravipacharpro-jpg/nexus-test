---
description: Triage GitHub issues and enforce ownership/routing rules.
mode: primary
hidden: true
model: nexus/gpt-5.4-mini
color: "#44BA81"
tools:
  "*": false
  "github-triage": true
...
Desktop application and browser-based app issues, including `nexus web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core nexus server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

NEXUS Zen, NEXUS Go, and billing issues.
