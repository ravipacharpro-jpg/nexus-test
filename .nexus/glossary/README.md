...
Use this folder for locale-specific translation guidance that supplements `.nexus/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/nexus/pull/12345

## Do Not Translate (Locale Additions)

- `NEXUS` (preserve casing)
