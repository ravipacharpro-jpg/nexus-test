...
- PR #15835: https://github.com/anomalyco/nexus/pull/15835

## Do Not Translate (Locale Additions)

- `NEXUS` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `nexus` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `NEXUS` in prose, `nexus` only for exact technical identifiers
...
- Avoid changing `nexus` to `NEXUS` inside commands, URLs, package names, or code literals
