...
- PR #13942: https://github.com/anomalyco/nexus/pull/13942

## Do Not Translate (Locale Additions)

- `NEXUS` (preserve casing in prose; keep `nexus` only when it is part of commands, package names, paths, or code)
- `NEXUS Zen`
- `NEXUS CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `nexus` in prose when referring to the product name; use `NEXUS`
