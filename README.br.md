<p align="center">
  <a href="https://nexus.ai">
    <picture>
      ...
      <img src="packages/console/app/src/asset/logo-ornate-light.svg" alt="Logo do NEXUS">
    </picture>
  </a>
</p>
...
1. `$NEXUS_INSTALL_DIR` - Diretório de instalação personalizado
2. `$XDG_BIN_DIR` - Caminho compatível com a especificação XDG Base Directory
3. `$HOME/bin` - Diretório binário padrão do usuário (se existir ou puder ser criado)
4. `$HOME/.nexus/bin` - Fallback padrão
...
O NEXUS inclui dois agents integrados, que você pode alternar com a tecla `Tab`.
...
Saiba mais sobre [agents](https://nexus.ai/docs/agents).

### Documentação

Para mais informações sobre como configurar o NEXUS, [**veja nossa documentação**](https://nexus.ai/docs).

### Contribuir

Se você tem interesse em contribuir com o NEXUS, leia os [contributing docs](./CONTRIBUTING.md) antes de enviar um pull request.

### Construindo com NEXUS

Se você estiver trabalhando em um projeto relacionado ao NEXUS e estiver usando "nexus" como parte do nome (por exemplo, "nexus-dashboard" ou "nexus-mobile"), adicione uma nota no README para deixar claro que não foi construído pela equipe do NEXUS e não é afiliado a nós de nenhuma forma.
