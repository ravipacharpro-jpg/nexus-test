...
const tableBucketName = `nexus-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `nexus-${$app.stage}-lake-ingest`,
    destination: "iceberg",
