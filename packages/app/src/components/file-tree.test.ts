...
beforeAll(async () => {
  ...
  mock.module("@nexus-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@nexus-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@nexus-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@nexus-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
