...
import type { Config, NexusClient, Project } from "@nexus-ai/sdk/v2/client"
import type { AgentApi, CatalogApi, CommandApi, ReferenceApi } from "@nexus-ai/client/promise"
import type { NormalizedProviderListResponse } from "@nexus-ai/session-ui/context"
import {
  bootstrapDirectory,
  loadAgentsQuery,
  loadCommands,
