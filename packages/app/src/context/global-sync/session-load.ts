import type { SessionApi } from "@nexus-ai/client/promise"
import { normalizeSessionInfo } from "@/utils/session"
import type { NexusClient } from "@nexus-ai/sdk/v2/client"
...
export async function loadRootSessionsV1(input: { client: NexusClient; directory: string; limit: number }) {
  try {
