import type { NEXUSEvent } from "@nexus-ai/client/promise"
import type { Event } from "@nexus-ai/sdk/v2/client"
...
export type ServerEvent = Event & { current?: NEXUSEvent }
...
export function adaptServerEvent(event: NEXUSEvent): ServerEvent {
...
function currentDelta(event: NEXUSEvent | undefined): CurrentDelta | undefined {
  if (
