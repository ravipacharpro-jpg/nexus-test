import type { NEXUSEvent, SessionMessageInfo, SessionPendingMessage } from "@nexus-ai/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: NEXUSEvent): V2SessionReduction | undefined => {
