export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل NEXUS",
  "desktop.recovery.terminated": "توقفت نافذة NEXUS بشكل غير متوقع",
  "desktop.recovery.unresponsive": "NEXUS لا يستجيب",
  ...
  "desktop.wsl.error.installNexus": "فشل تثبيت NEXUS",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.nexusMissing": "nexus غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.nexusCannotRun": "nexus مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث NEXUS، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.nexus.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.nexus.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.nexusGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من NEXUS",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "يمنحك NEXUS Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.nexusZen.visit.prefix": "قم بزيارة ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في NEXUS.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في nexus.json",
  ...
  "dialog.server.description": "تبديل خادم NEXUS الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingNexus": "جارٍ التحقق من NEXUS...",
  "wsl.onboarding.checkingNexusIn": "جارٍ التحقق من NEXUS في {{distro}}...",
  "wsl.onboarding.updatingNexus": "جارٍ تحديث NEXUS...",
  "wsl.onboarding.updatingNexusIn": "جارٍ تحديث NEXUS في {{distro}}...",
  "wsl.onboarding.updateNexusIn": "حدّث NEXUS في {{distro}}.",
  "wsl.onboarding.updateNexus": "تحديث NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS جاهز في {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS جاهز.",
  "wsl.onboarding.installNexusIn": "ثبّت NEXUS في {{distro}}.",
  "wsl.onboarding.installNexus": "تثبيت NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن NEXUS من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على NEXUS التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح NEXUS.",
  ...
  "help.tabs.introduction": "أصبح NEXUS Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من NEXUS ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق NEXUS",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (nexus.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن NEXUS لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن NEXUS نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم NEXUS داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ NEXUS",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور NEXUS على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان NEXUS يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة NEXUS.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل NEXUS",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من NEXUS.",
