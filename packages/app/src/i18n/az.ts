export const dict = {
  ...
  "desktop.recovery.loadFailed": "NEXUS yüklənə bilmədi",
  "desktop.recovery.terminated": "NEXUS pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "NEXUS cavab vermir",
  ...
  "desktop.wsl.error.installNexus": "NEXUS quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.nexusMissing": "Bu distribütivdə nexus quraşdırılmayıb",
  "desktop.wsl.error.nexusCannotRun": "nexus quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "NEXUS yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.nexus.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.nexus.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.nexusGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "NEXUS tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və NEXUS-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  "provider.connect.nexusZen.line2":
    "Tək bir API açarı ilə Claude, GPT, Gemini, GLM və daha çox modellərə giriş əldə edəcəksiniz.",
  "provider.connect.nexusZen.visit.prefix": "",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və NEXUS-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və NEXUS-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər nexus.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu NEXUS serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingNexus": "NEXUS yoxlanılır...",
  "wsl.onboarding.checkingNexusIn": "{{distro}}-də NEXUS yoxlanılır...",
  "wsl.onboarding.updatingNexus": "NEXUS yenilənir...",
  "wsl.onboarding.updatingNexusIn": "{{distro}}-də NEXUS yenilənir...",
  "wsl.onboarding.updateNexusIn": "{{distro}}-də NEXUS-u yeniləyin.",
  "wsl.onboarding.updateNexus": "NEXUS-u yeniləyin",
  "wsl.onboarding.nexusReadyIn": "NEXUS {{distro}}-də hazırdır.",
  "wsl.onboarding.nexusReady": "NEXUS hazırdır.",
  "wsl.onboarding.installNexusIn": "NEXUS-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installNexus": "NEXUS quraşdırın",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NEXUS WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "NEXUS bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra NEXUS-u yenidən açın.",
  ...
  "help.tabs.introduction": "NEXUS Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NEXUS-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı NEXUS komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (nexus.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: NEXUS hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində NEXUS serverini işlət.",
  ...
  "settings.general.row.language.description": "NEXUS üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "NEXUS-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "NEXUS-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "NEXUS-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "NEXUS açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "NEXUS-un ən son versiyasından istifadə edirsiniz.",
