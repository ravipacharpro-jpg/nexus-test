export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do NEXUS",
  ...
  "desktop.menu.ariaLabel": "Menu do NEXUS",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o NEXUS",
  "desktop.recovery.terminated": "A janela do NEXUS foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O NEXUS não está respondendo",
  ...
  "desktop.wsl.error.installNexus": "Falha na instalação do NEXUS",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.nexusMissing": "O nexus não está instalado nesta distribuição",
  "desktop.wsl.error.nexusCannotRun": "O nexus está instalado, mas não pôde ser executado",
  "desktop.wsl.error.nexusNotInstalled": "O NEXUS não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do NEXUS foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.nexus.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.nexus.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.nexusGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.nexusZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.nexusZen.visit.prefix": "Visite ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no NEXUS.",
  ...
  "dialog.plugins.empty": "Plugins configurados em nexus.json",
  ...
  "dialog.server.description": "Trocar para qual servidor NEXUS este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingNexus": "Verificando o NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Verificando o NEXUS em {{distro}}...",
  "wsl.onboarding.updatingNexus": "Atualizando o NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Atualizando o NEXUS em {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Atualize o NEXUS em {{distro}}.",
  "wsl.onboarding.updateNexus": "Atualizar o NEXUS",
  "wsl.onboarding.nexusReadyIn": "O NEXUS está pronto em {{distro}}.",
  "wsl.onboarding.nexusReady": "O NEXUS está pronto.",
  "wsl.onboarding.installNexusIn": "Instale o NEXUS em {{distro}}.",
  "wsl.onboarding.installNexus": "Instalar o NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o NEXUS possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O NEXUS não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o NEXUS novamente.",
  ...
  "help.tabs.introduction": "Agora, o NEXUS Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do NEXUS ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do NEXUS",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (nexus.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: NEXUS ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor NEXUS dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do NEXUS",
  ...
  "settings.general.row.appearance.description": "Personalize como o NEXUS aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o NEXUS segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o NEXUS é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o NEXUS iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do NEXUS.",
