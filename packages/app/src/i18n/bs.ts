export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za NEXUS",
  ...
  "desktop.menu.ariaLabel": "NEXUS meni",
  ...
  "desktop.recovery.loadFailed": "NEXUS se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor NEXUS-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "NEXUS ne reaguje",
  ...
  "desktop.wsl.error.installNexus": "Instalacija NEXUS-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.nexusMissing": "nexus nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.nexusCannotRun": "nexus je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje NEXUS-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.nexus.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.nexus.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.nexusGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u NEXUS-u.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.nexusZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.nexusZen.visit.prefix": "Posjeti ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u NEXUS-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u NEXUS-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u nexus.json",
  ...
  "dialog.server.description": "Promijeni na koji se NEXUS server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingNexus": "Provjera NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Provjera NEXUS u distribuciji {{distro}}...",
  "wsl.onboarding.updatingNexus": "Ažuriranje NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Ažuriranje NEXUS u distribuciji {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Ažuriraj NEXUS u distribuciji {{distro}}.",
  "wsl.onboarding.updateNexus": "Ažuriraj NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS je spreman.",
  "wsl.onboarding.installNexusIn": "Instaliraj NEXUS u distribuciji {{distro}}.",
  "wsl.onboarding.installNexus": "Instaliraj NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi NEXUS mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "NEXUS nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori NEXUS.",
  ...
  "help.tabs.introduction": "NEXUS Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija NEXUS-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku NEXUS timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (nexus.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: NEXUS još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni NEXUS server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u NEXUS-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako NEXUS izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li NEXUS prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu NEXUS-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se NEXUS pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju NEXUS-a.",
