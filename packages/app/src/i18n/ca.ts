export const dict = {
  ...
  "desktop.menu.documentation": "NEXUS Documentació",
  ...
  "desktop.menu.ariaLabel": "menú NEXUS.",
  ...
  "desktop.recovery.loadFailed": "NEXUS no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra NEXUS s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "NEXUS no respon",
  ...
  "desktop.wsl.error.installNexus": "La instal·lació de NEXUS ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.nexusMissing": "nexus no està instal·lat en aquesta distribució",
  "desktop.wsl.error.nexusCannotRun": "nexus està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NEXUS actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.nexus.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.nexus.tagline": "Models optimitzats fiables",
  "dialog.provider.nexusGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.nexusZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a NEXUS.",
  ...
  "dialog.plugins.empty": "Connectors configurats a nexus.json",
  ...
  "dialog.server.description": "Canvia a quin NEXUS servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingNexus": "S'està comprovant NEXUS...",
  "wsl.onboarding.checkingNexusIn": "S'està registrant NEXUS a {{distro}}...",
  "wsl.onboarding.updatingNexus": "S'està actualitzant NEXUS...",
  "wsl.onboarding.updatingNexusIn": "S'està actualitzant NEXUS a {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Actualitza NEXUS a {{distro}}.",
  "wsl.onboarding.updateNexus": "Actualització NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS està llest a {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS està llest.",
  "wsl.onboarding.installNexusIn": "Instal·leu NEXUS a {{distro}}.",
  "wsl.onboarding.installNexus": "Instal·la NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que NEXUS pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "NEXUS no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir NEXUS.",
  ...
  "help.tabs.introduction": "NEXUS L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de NEXUS ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip NEXUS.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (nexus.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que NEXUS encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "NEXUS Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor NEXUS dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a NEXUS",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu NEXUS al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si NEXUS segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de NEXUS.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï NEXUS.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de NEXUS.",
