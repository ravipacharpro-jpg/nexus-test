export const dict = {
  ...
  "desktop.menu.documentation": "NEXUS Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka NEXUS",
  ...
  "desktop.recovery.loadFailed": "NEXUS se nepodařilo načíst",
  "desktop.recovery.terminated": "NEXUS okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "NEXUS nereaguje",
  ...
  "desktop.wsl.error.installNexus": "NEXUS instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.nexusMissing": "nexus není v této distribuci nainstalováno",
  "desktop.wsl.error.nexusCannotRun": "nexus je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NEXUS aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.nexus.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.nexus.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.nexusGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.nexusZen.visit.prefix": "Návštěva ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v NEXUS.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v nexus.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému NEXUS serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingNexus": "Kontrola NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Kontrola NEXUS v {{distro}}...",
  "wsl.onboarding.updatingNexus": "Aktualizace NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Aktualizace NEXUS v {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Aktualizace NEXUS v {{distro}}.",
  "wsl.onboarding.updateNexus": "Aktualizovat NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS je připraveno v {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS je připraven.",
  "wsl.onboarding.installNexusIn": "Nainstalujte NEXUS do {{distro}}.",
  "wsl.onboarding.installNexus": "Instalovat NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než NEXUS může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "NEXUS nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete NEXUS.",
  ...
  "help.tabs.introduction": "NEXUS Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze NEXUS ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu NEXUS",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (nexus.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: NEXUS zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server NEXUS uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro NEXUS",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled NEXUS na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude NEXUS následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma NEXUS.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění NEXUS",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi NEXUS.",
