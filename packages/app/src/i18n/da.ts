export const dict = {
  ...
  "dialog.provider.nexus.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.nexus.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.nexusGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.nexusZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.nexusZen.visit.prefix": "Besøg ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i NEXUS.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i nexus.json",
  ...
  "dialog.server.description": "Skift hvilken NEXUS-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingNexus": "Tjekker NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Tjekker NEXUS i {{distro}}...",
  "wsl.onboarding.updatingNexus": "Opdaterer NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Opdaterer NEXUS i {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Opdater NEXUS i {{distro}}.",
  "wsl.onboarding.updateNexus": "Opdater NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før NEXUS kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "NEXUS kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter NEXUS igen.",
  ...
  "toast.update.description": "En ny version af NEXUS ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til NEXUS-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (nexus.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, NEXUS understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør NEXUS-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for NEXUS",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan NEXUS ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om NEXUS skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas NEXUSs tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når NEXUS starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af NEXUS.",
  ...
  "desktop.recovery.loadFailed": "NEXUS kunne ikke indlæses",
  "desktop.recovery.terminated": "NEXUS-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installNexus": "Installationen af NEXUS mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.nexusMissing": "nexus er ikke installeret i denne distribution",
  "desktop.wsl.error.nexusCannotRun": "nexus er installeret, men kunne ikke køre",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af NEXUS er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "NEXUS Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
