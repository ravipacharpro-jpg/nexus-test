...
export const dict = {
  ...
  "dialog.provider.nexus.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.nexus.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.nexusGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in NEXUS zu nutzen.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.nexusZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in NEXUS zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in NEXUS zu nutzen.",
  ...
  "dialog.plugins.empty": "In nexus.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den NEXUS-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingNexus": "NEXUS wird geprüft…",
  "wsl.onboarding.checkingNexusIn": "NEXUS in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingNexus": "NEXUS wird aktualisiert…",
  "wsl.onboarding.updatingNexusIn": "NEXUS in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateNexusIn": "Aktualisieren Sie NEXUS in {{distro}}.",
  "wsl.onboarding.updateNexus": "NEXUS aktualisieren",
  "wsl.onboarding.nexusReadyIn": "NEXUS ist in {{distro}} bereit.",
  "wsl.onboarding.nexusReady": "NEXUS ist bereit.",
  "wsl.onboarding.installNexusIn": "Installieren Sie NEXUS in {{distro}}.",
  "wsl.onboarding.installNexus": "NEXUS installieren",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor NEXUS einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "NEXUS konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann NEXUS erneut.",
  ...
  "toast.update.description": "Eine neue Version von NEXUS ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem NEXUS-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (nexus.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: NEXUS unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "NEXUS mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "NEXUS enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "NEXUS Desktop",
  ...
  "settings.desktop.wsl.description": "NEXUS-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für NEXUS ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie NEXUS auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob NEXUS dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von NEXUS anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von NEXUS automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "NEXUS ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von NEXUS wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "NEXUS konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das NEXUS-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "NEXUS reagiert nicht",
  ...
  "desktop.wsl.error.installNexus": "NEXUS-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.nexusMissing": "nexus ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.nexusCannotRun": "nexus ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das NEXUS-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "NEXUS Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
