...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "NEXUS failed to load",
  "desktop.recovery.terminated": "NEXUS window terminated unexpectedly",
  "desktop.recovery.unresponsive": "NEXUS is not responding",
  ...
  "desktop.wsl.error.installNexus": "NEXUS installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.nexusMissing": "nexus is not installed in this distro",
  "desktop.wsl.error.nexusCannotRun": "nexus is installed but could not run",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NEXUS update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
