...
export const dict = {
  ...
  "dialog.provider.nexus.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.nexus.tagline": "Reliable optimized models",
  "dialog.provider.nexusGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in NEXUS.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.nexusZen.line1":
    "NEXUS Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.nexusZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.nexusZen.visit.prefix": "Visit ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in NEXUS.",
  ...
  "dialog.plugins.empty": "Plugins configured in nexus.json",
  ...
  "dialog.server.description": "Switch which NEXUS server this app connects to.",
  ...
  "wsl.onboarding.checkingNexus": "Checking NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Checking NEXUS in {{distro}}...",
  "wsl.onboarding.updatingNexus": "Updating NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Updating NEXUS in {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Update NEXUS in {{distro}}.",
  "wsl.onboarding.updateNexus": "Update NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS is ready in {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS is ready.",
  "wsl.onboarding.installNexusIn": "Install NEXUS in {{distro}}.",
  "wsl.onboarding.installNexus": "Install NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before NEXUS can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "NEXUS could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen NEXUS.",
  ...
  "help.tabs.introduction": "NEXUS Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of NEXUS ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the NEXUS team",
  ...
  "error.chain.checkConfig": "Check your config (nexus.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, NEXUS does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the NEXUS server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for NEXUS",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how NEXUS looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether NEXUS follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how NEXUS is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when NEXUS launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of NEXUS.",
