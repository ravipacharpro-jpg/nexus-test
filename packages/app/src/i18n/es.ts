export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de NEXUS",
  ...
  "desktop.menu.ariaLabel": "Menú de NEXUS",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar NEXUS",
  "desktop.recovery.terminated": "La ventana de NEXUS se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "NEXUS no responde",
  ...
  "desktop.wsl.error.installNexus": "No se pudo instalar NEXUS",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.nexusMissing": "nexus no está instalado en esta distribución",
  "desktop.wsl.error.nexusCannotRun": "nexus está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de NEXUS finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.nexus.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.nexus.tagline": "Modelos optimizados y fiables",
  "dialog.provider.nexusGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.nexusZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en NEXUS.",
  ...
  "dialog.plugins.empty": "Plugins configurados en nexus.json",
  ...
  "dialog.server.description": "Cambiar el servidor de NEXUS al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingNexus": "Comprobando NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Comprobando NEXUS en {{distro}}...",
  "wsl.onboarding.updatingNexus": "Actualizando NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Actualizando NEXUS en {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Actualiza NEXUS en {{distro}}.",
  "wsl.onboarding.updateNexus": "Actualizar NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS está listo en {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS está listo.",
  "wsl.onboarding.installNexusIn": "Instala NEXUS en {{distro}}.",
  "wsl.onboarding.installNexus": "Instalar NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que NEXUS pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "NEXUS no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir NEXUS.",
  ...
  "help.tabs.introduction": "NEXUS Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de NEXUS ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de NEXUS",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (nexus.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: NEXUS aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor NEXUS dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para NEXUS",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve NEXUS en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si NEXUS sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de NEXUS.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia NEXUS",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de NEXUS.",
