export const dict = {
  ...
  "desktop.recovery.loadFailed": "NEXUS laadimine ebaõnnestus",
  "desktop.recovery.terminated": "NEXUS aken suleti ootamatult",
  "desktop.recovery.unresponsive": "NEXUS ei vasta",
  ...
  "desktop.wsl.error.installNexus": "NEXUS installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.nexusMissing": "nexus pole sellesse distrosse installitud",
  "desktop.wsl.error.nexusCannotRun": "nexus on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NEXUS värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.nexus.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.nexus.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.nexusGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid NEXUS'is.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.nexusZen.visit.prefix": "Külastage ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises NEXUS.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis nexus.json",
  ...
  "dialog.server.description": "Lülitage, millise NEXUS serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingNexus": "NEXUS kontrollimine...",
  "wsl.onboarding.checkingNexusIn": "NEXUS kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingNexus": "NEXUS värskendamine...",
  "wsl.onboarding.updatingNexusIn": "NEXUS värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Värskenda NEXUS jaotises {{distro}}.",
  "wsl.onboarding.updateNexus": "Värskenda NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS on valmis {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS on valmis.",
  "wsl.onboarding.installNexusIn": "Installige NEXUS asukohta {{distro}}.",
  "wsl.onboarding.installNexus": "Installige NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui NEXUS saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "NEXUS ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti NEXUS.",
  ...
  "help.tabs.introduction": "NEXUS Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse NEXUS ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast NEXUS meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (nexus.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, NEXUS ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "NEXUS Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage NEXUS server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke NEXUS kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas NEXUS teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas NEXUS järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas NEXUS on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui NEXUS käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse NEXUS uusimat versiooni.",
