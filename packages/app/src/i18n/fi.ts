export const dict = {
  ...
  "dialog.provider.nexus.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.nexus.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.nexusGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "NEXUSn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja NEXUSssa.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.nexusZen.visit.prefix": "Avaa ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja NEXUSssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja NEXUSssa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään nexus.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda NEXUS-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingNexus": "Tarkistetaan NEXUSa...",
  "wsl.onboarding.checkingNexusIn": "Tarkistetaan NEXUSa kohteessa {{distro}}...",
  "wsl.onboarding.updatingNexus": "Päivitetään NEXUSa...",
  "wsl.onboarding.updatingNexusIn": "Päivitetään NEXUSa kohteessa {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Päivitä NEXUS jakelussa {{distro}}.",
  "wsl.onboarding.updateNexus": "Päivitä NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS on valmis jakelussa {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS on valmis.",
  "wsl.onboarding.installNexusIn": "Asenna NEXUS jakeluun {{distro}}.",
  "wsl.onboarding.installNexus": "Asenna NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUSa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin NEXUS voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "NEXUS ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten NEXUS uudelleen.",
  ...
  "toast.update.description": "NEXUSn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä NEXUS-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (nexus.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että NEXUS ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita NEXUS-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda NEXUSn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä NEXUS näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö NEXUS järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta NEXUSn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun NEXUS käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät NEXUSn uusinta versiota.",
  ...
  "desktop.menu.documentation": "NEXUS-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "NEXUS-valikko",
  ...
  "desktop.recovery.loadFailed": "NEXUSn lataaminen epäonnistui",
  "desktop.recovery.terminated": "NEXUS-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "NEXUS ei vastaa",
  ...
  "desktop.wsl.error.installNexus": "NEXUSn asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.nexusMissing": "nexusa ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.nexusCannotRun": "nexus on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.nexusNotInstalled": "NEXUSa ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NEXUSn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "NEXUS Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
