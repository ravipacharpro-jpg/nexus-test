export const dict = {
  ...
  "desktop.menu.documentation": "NEXUS Skjøl",
  ...
  "desktop.menu.ariaLabel": "NEXUS valmynd",
  ...
  "desktop.recovery.loadFailed": "NEXUS miseydnaðist at heinta",
  "desktop.recovery.terminated": "NEXUS vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "NEXUS svarar ikki",
  ...
  "desktop.wsl.error.installNexus": "NEXUS uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.nexusMissing": "nexus er ikki sett upp í hesi distro",
  "desktop.wsl.error.nexusCannotRun": "nexus er sett upp men kundi ikki koyra",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NEXUS dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.nexus.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.nexus.tagline": "Álítandi optimerað modell",
  "dialog.provider.nexusGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.nexusZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.nexusZen.visit.prefix": "Vitja ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í NEXUS.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í nexus.json",
  ...
  "dialog.server.description": "Skift hvønn NEXUS ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingNexus": "Kanna NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Kanna NEXUS í {{distro}}...",
  "wsl.onboarding.updatingNexus": "Dagføring NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Dagføring NEXUS í {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Dagfør NEXUS í {{distro}}.",
  "wsl.onboarding.updateNexus": "Dagfør NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS er klárt í {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS er klárt.",
  "wsl.onboarding.installNexusIn": "Set NEXUS upp í {{distro}}.",
  "wsl.onboarding.installNexus": "Set upp NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn NEXUS kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "NEXUS kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani NEXUS aftur.",
  ...
  "help.tabs.introduction": "NEXUS Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av NEXUS ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til NEXUS toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (nexus.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, NEXUS stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "NEXUS Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr NEXUS ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri NEXUS",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu NEXUS sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um NEXUS fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu NEXUS er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá NEXUS byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av NEXUS.",
