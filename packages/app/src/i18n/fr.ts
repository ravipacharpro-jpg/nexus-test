export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'NEXUS",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'NEXUS",
  "desktop.recovery.terminated": "La fenêtre NEXUS s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "NEXUS ne répond pas",
  ...
  "desktop.wsl.error.installNexus": "Échec de l'installation d'NEXUS",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.nexusMissing": "nexus n'est pas installé dans cette distribution",
  "desktop.wsl.error.nexusCannotRun": "nexus est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'NEXUS est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.nexus.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.nexus.tagline": "Modèles optimisés et fiables",
  "dialog.provider.nexusGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.nexusZen.visit.prefix": "Visitez ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans NEXUS.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans nexus.json",
  ...
  "dialog.server.description": "Changez le serveur NEXUS auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingNexus": "Vérification d'NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Vérification d'NEXUS dans {{distro}}...",
  "wsl.onboarding.updatingNexus": "Mise à jour d'NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Mise à jour d'NEXUS dans {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Mettez à jour NEXUS dans {{distro}}.",
  "wsl.onboarding.updateNexus": "Mettre à jour NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS est prêt dans {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS est prêt.",
  "wsl.onboarding.installNexusIn": "Installez NEXUS dans {{distro}}.",
  "wsl.onboarding.installNexus": "Installer NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'NEXUS puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "NEXUS n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez NEXUS.",
  ...
  "help.tabs.introduction": "NEXUS Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'NEXUS ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe NEXUS",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (nexus.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'NEXUS ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "NEXUS inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur NEXUS dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour NEXUS",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'NEXUS sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si NEXUS suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'NEXUS.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'NEXUS",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'NEXUS.",
