...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "NEXUS se nije uspio učitati",
  "Prozor aplikacije NEXUS neočekivano je zatvoren",
  "NEXUS ne reagira",
  ...
  "Instalacija aplikacije NEXUS nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "nexus nije instaliran u ovoj distribuciji",
  "nexus je instaliran, ali se ne može pokrenuti",
  "NEXUS nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije NEXUS je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.nexus.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.nexus.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.nexusGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.nexusZen.visit.prefix": "Posjetiti",
  "provider.connect.nexusZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.nexusZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u NEXUS.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u nexus.json",
  ...
  "dialog.server.description": "Promijenite na koji se NEXUS poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingNexusIn": "Provjera NEXUS u {{distro}}...",
  "wsl.onboarding.updatingNexus": "Ažuriranje NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Ažuriranje NEXUS u {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Ažurirajte NEXUS u {{distro}}.",
  "wsl.onboarding.updateNexus": "Ažurirajte NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS je spreman u {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS je spreman.",
  "wsl.onboarding.installNexusIn": "Instalirajte NEXUS u {{distro}}.",
  "wsl.onboarding.installNexus": "Instalirajte NEXUS",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što NEXUS može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "NEXUS nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite NEXUS.",
  ...
  "help.tabs.introduction": "Radna površina NEXUS sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija NEXUS ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku NEXUS timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (nexus.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, NEXUS još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "NEXUS Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite NEXUS poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za NEXUS",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako NEXUS izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li NEXUS slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je NEXUS tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se NEXUS pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju NEXUS.",
