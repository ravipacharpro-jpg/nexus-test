...
const desktop = [
  ...
  "Kilépés",
  "Az NEXUS betöltése sikertelen",
  "Az NEXUS ablaka váratlanul leállt",
  "Az NEXUS nem válaszol",
  ...
  "Az NEXUS telepítése sikertelen",
  "A(z) {{distro}} már hozzá van adva",
  "Az nexus nincs telepítve ebben a disztribúcióban",
  "Az nexus telepítve van, de nem futtatható",
  "Az NEXUS nincs telepítve ebben: {{distro}}",
  "Az NEXUS frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.nexus.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.nexus.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.nexusGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.unpaid.freeModels.title": "A NEXUS ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a NEXUS-ben.",
  ...
  "provider.connect.nexusZen.line1":
    "A NEXUS Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.nexusZen.visit.prefix": "Látogatás",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a NEXUS-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a NEXUS-ben.",
  ...
  "dialog.plugins.empty": "Az nexus.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik NEXUS szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingNexus": "NEXUS ellenőrzése...",
  "wsl.onboarding.checkingNexusIn": "NEXUS ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingNexus": "NEXUS frissítése...",
  "wsl.onboarding.updatingNexusIn": "NEXUS frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateNexusIn": "Frissítse a NEXUS-t a {{distro}}-ben.",
  "wsl.onboarding.updateNexus": "Frissítse a NEXUS-t",
  "wsl.onboarding.nexusReadyIn": "A NEXUS készen áll a {{distro}}-ben.",
  "wsl.onboarding.nexusReady": "A NEXUS készen áll.",
  "wsl.onboarding.installNexusIn": "Telepítse a NEXUS-t a {{distro}}-be.",
  "wsl.onboarding.installNexus": "Telepítse a NEXUS-t",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "A NEXUS nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a NEXUS hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A NEXUS nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a NEXUS programot.",
  ...
  "help.tabs.introduction": "A NEXUS Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A NEXUS ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a NEXUS csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (nexus.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a NEXUS még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A NEXUS ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "NEXUS asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a NEXUS szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a NEXUS kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a NEXUS az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a NEXUS a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a NEXUS témáját.",
  ...
  "settings.updates.row.startup.description": "A NEXUS indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a NEXUS legújabb verzióját futtatja.",
