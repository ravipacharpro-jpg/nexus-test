export const dict = {
  ...
  "desktop.menu.documentation": "NEXUS Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "NEXUS մենյու",
  ...
  "desktop.recovery.loadFailed": "NEXUS չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "NEXUS պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "NEXUS-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installNexus": "NEXUS տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.nexusMissing": "nexus-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.nexusCannotRun": "nexus-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NEXUS թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.nexus.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.nexus.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.nexusGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և NEXUS-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.nexusZen.visit.prefix": "Այցելություն ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և NEXUS-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և NEXUS-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են nexus.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ NEXUS սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingNexus": "Ստուգում է NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Ստուգում է NEXUS-ը {{distro}}...",
  "wsl.onboarding.updatingNexus": "Թարմացվում է NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Թարմացվում է NEXUS-ը {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Թարմացնել NEXUS-ը {{distro}}-ում։",
  "wsl.onboarding.updateNexus": "Թարմացնել NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.nexusReady": "NEXUS պատրաստ է։",
  "wsl.onboarding.installNexusIn": "Տեղադրեք NEXUS-ը {{distro}}-ում։",
  "wsl.onboarding.installNexus": "Տեղադրեք NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի NEXUS-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "NEXUS-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք NEXUS։",
  ...
  "help.tabs.introduction": "NEXUS Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NEXUS-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին NEXUS թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (nexus.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ NEXUS-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "NEXUS ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք NEXUS սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն NEXUS",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է NEXUS տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ NEXUS-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է NEXUS-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ NEXUS-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք NEXUS-ի վերջին տարբերակը։",
