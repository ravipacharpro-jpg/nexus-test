export const dict = {
  ...
  "desktop.recovery.loadFailed": "NEXUS gagal dimuat",
  "desktop.recovery.terminated": "Jendela NEXUS berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "NEXUS tidak merespons",
  ...
  "desktop.wsl.error.installNexus": "Instalasi NEXUS gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.nexusMissing": "nexus belum terinstal di distro ini",
  "desktop.wsl.error.nexusCannotRun": "nexus telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan NEXUS selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.nexus.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.nexus.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.nexusGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.nexusZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di NEXUS.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di nexus.json",
  ...
  "dialog.server.description": "Ganti server NEXUS mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingNexus": "Memeriksa NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Memeriksa NEXUS di {{distro}}...",
  "wsl.onboarding.updatingNexus": "Memperbarui NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Memperbarui NEXUS di {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Perbarui NEXUS di {{distro}}.",
  "wsl.onboarding.updateNexus": "Perbarui NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS siap di {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS siap.",
  "wsl.onboarding.installNexusIn": "Instal NEXUS di {{distro}}.",
  "wsl.onboarding.installNexus": "Instal NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum NEXUS dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "NEXUS tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali NEXUS.",
  ...
  "help.tabs.introduction": "NEXUS Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru NEXUS ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim NEXUS",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (nexus.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: NEXUS belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server NEXUS di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk NEXUS",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan NEXUS di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah NEXUS mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat NEXUS diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru NEXUS.",
