...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða NEXUS",
  "NEXUS-glugganum var óvænt lokað",
  "NEXUS svarar ekki",
  ...
  "Uppsetning NEXUS mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "nexus er ekki uppsett í þessari dreifingu",
  "nexus er uppsett en ekki var hægt að keyra það",
  "NEXUS er ekki uppsett í {{distro}}",
  "Uppfærslu NEXUS lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.nexus.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.nexus.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.nexusGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.nexusZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.nexusZen.visit.prefix": "Heimsókn",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í NEXUS.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í nexus.json",
  ...
  "dialog.server.description": "Skiptu um hvaða NEXUS miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingNexus": "Athugar NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Athugar NEXUS í {{distro}}...",
  "wsl.onboarding.updatingNexus": "Uppfærir NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Uppfærir NEXUS í {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Uppfærðu NEXUS í {{distro}}.",
  "wsl.onboarding.updateNexus": "Uppfærðu NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS er tilbúið í {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS er tilbúinn.",
  "wsl.onboarding.installNexusIn": "Settu upp NEXUS í {{distro}}.",
  "wsl.onboarding.installNexus": "Settu upp NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en NEXUS getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "NEXUS gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan NEXUS aftur.",
  ...
  "help.tabs.introduction": "NEXUS Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af NEXUS ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til NEXUS teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (nexus.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, NEXUS styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "NEXUS inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "NEXUS skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu NEXUS netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir NEXUS",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig NEXUS lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort NEXUS fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig NEXUS er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar NEXUS ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af NEXUS.",
