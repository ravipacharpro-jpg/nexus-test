export const dict = {
  ...
  "dialog.provider.nexus.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.nexus.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.nexusGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.nexusZen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.nexusZen.visit.prefix": "Visita ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in NEXUS.",
  ...
  "dialog.plugins.empty": "Plugin configurati in nexus.json",
  ...
  "dialog.server.description": "Cambia il server NEXUS a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingNexus": "Controllo NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Controllo NEXUS in {{distro}}...",
  "wsl.onboarding.updatingNexus": "Aggiornamento NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Aggiornamento NEXUS in {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Aggiorna NEXUS in {{distro}}.",
  "wsl.onboarding.updateNexus": "Aggiorna NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS è pronto in {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS è pronto.",
  "wsl.onboarding.installNexusIn": "Installa NEXUS in {{distro}}.",
  "wsl.onboarding.installNexus": "Installa NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che NEXUS possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "NEXUS non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri NEXUS.",
  ...
  "help.tabs.introduction": "NEXUS Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di NEXUS ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team NEXUS",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (nexus.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: NEXUS non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server NEXUS all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per NEXUS",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di NEXUS sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se NEXUS segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di NEXUS.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di NEXUS",
  ...
  "settings.updates.toast.latest.title": "NEXUS è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di NEXUS.",
  ...
  "desktop.menu.documentation": "Documentazione di NEXUS",
  ...
  "desktop.menu.ariaLabel": "Menu NEXUS",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare NEXUS",
  "desktop.recovery.terminated": "La finestra di NEXUS si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "NEXUS non risponde",
  ...
  "desktop.wsl.error.installNexus": "Installazione di NEXUS non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.nexusMissing": "nexus non è installato in questa distribuzione",
  "desktop.wsl.error.nexusCannotRun": "nexus è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di NEXUS è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
