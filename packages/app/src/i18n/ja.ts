export const dict = {
  ...
  "desktop.recovery.loadFailed": "NEXUSを読み込めませんでした",
  "desktop.recovery.terminated": "NEXUSのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "NEXUSが応答していません",
  ...
  "desktop.wsl.error.installNexus": "NEXUSのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.nexusMissing": "このディストリビューションにはnexusがインストールされていません",
  "desktop.wsl.error.nexusCannotRun": "nexusはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.nexusNotInstalled": "{{distro}}にはNEXUSがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "NEXUSのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.nexus.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.nexus.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.nexusGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "NEXUSが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、NEXUSで{{provider}}モデルを使用します。",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.nexusZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.nexusZen.visit.prefix": " ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してNEXUSで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、NEXUSで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "nexus.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するNEXUSサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingNexus": "NEXUSを確認中...",
  "wsl.onboarding.checkingNexusIn": "{{distro}}内のNEXUSを確認中...",
  "wsl.onboarding.updatingNexus": "NEXUSを更新中...",
  "wsl.onboarding.updatingNexusIn": "{{distro}}内のNEXUSを更新中...",
  "wsl.onboarding.updateNexusIn": "{{distro}}内のNEXUSを更新してください。",
  "wsl.onboarding.updateNexus": "NEXUSを更新",
  "wsl.onboarding.nexusReadyIn": "{{distro}}内のNEXUSの準備ができました。",
  "wsl.onboarding.nexusReady": "NEXUSの準備ができました。",
  "wsl.onboarding.installNexusIn": "{{distro}}にNEXUSをインストールしてください。",
  "wsl.onboarding.installNexus": "NEXUSをインストール",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUSがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NEXUSでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、NEXUSをもう一度開いてください。",
  ...
  "help.tabs.introduction": "NEXUS Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NEXUSの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをNEXUSチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (nexus.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: NEXUSはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "NEXUSには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でNEXUSサーバーを実行します。",
  ...
  "settings.general.row.language.description": "NEXUSの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのNEXUSの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "NEXUSがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "NEXUSのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "NEXUS の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "NEXUS は最新バージョンです。",
