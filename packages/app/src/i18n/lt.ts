...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "NEXUS įkelti nepavyko",
  "NEXUS langas netikėtai užsidarė",
  "NEXUS neatsako",
  ...
  "NEXUS įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "nexus šiame distributyve neįdiegtas",
  "nexus įdiegtas, bet jo paleisti nepavyko",
  "NEXUS neįdiegtas distributyve {{distro}}",
  "NEXUS naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.nexus.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.nexus.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.nexusGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami NEXUS modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  "provider.connect.nexusZen.line2":
    "Su vienu API raktu galėsite pasiekti tokius modelius kaip Claude, GPT, Gemini, GLM ir kt.",
  "provider.connect.nexusZen.visit.prefix": "Aplankykite",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius NEXUS.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti nexus.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio NEXUS serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingNexus": "Tikrinama NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Tikrinama NEXUS {{distro}}...",
  "wsl.onboarding.updatingNexus": "Atnaujinamas NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Atnaujinamas NEXUS {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Atnaujinkite NEXUS {{distro}}.",
  "wsl.onboarding.updateNexus": "Atnaujinkite NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS yra paruoštas {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS yra paruoštas.",
  "wsl.onboarding.installNexusIn": "Įdiekite NEXUS į {{distro}}.",
  "wsl.onboarding.installNexus": "Įdiekite NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad NEXUS galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "NEXUS nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite NEXUS.",
  ...
  "help.tabs.introduction": "NEXUS Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują NEXUS ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą NEXUS komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (nexus.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad NEXUS dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "NEXUS apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "NEXUS darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite NEXUS serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite NEXUS ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip NEXUS atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar NEXUS seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite NEXUS temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas NEXUS",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią NEXUS versiją.",
