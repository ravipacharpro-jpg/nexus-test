export const dict = {
  ...
  "desktop.menu.documentation": "NEXUS dokumentācija",
  ...
  "desktop.menu.ariaLabel": "NEXUS izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt NEXUS",
  "desktop.recovery.terminated": "NEXUS logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "NEXUS neatbild",
  ...
  "desktop.wsl.error.installNexus": "NEXUS instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.nexusMissing": "nexus nav instalēts šajā distribūcijā",
  "desktop.wsl.error.nexusCannotRun": "nexus ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NEXUS atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.nexus.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.nexus.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.nexusGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  "provider.connect.nexusZen.line2":
    "Ar vienu API atslēgu iegūsiet piekļuvi tādiem modeļiem kā Claude, GPT, Gemini, GLM un citiem.",
  "provider.connect.nexusZen.visit.prefix": "Apmeklējiet",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus NEXUS.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti nexus.json",
  ...
  "dialog.server.description": "Mainiet, pie kura NEXUS servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingNexus": "Pārbaudu NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Pārbaudu NEXUS distribūcijā {{distro}}...",
  "wsl.onboarding.updatingNexus": "Atjauninu NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Atjauninu NEXUS distribūcijā {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Atjauniniet NEXUS distribūcijā {{distro}}.",
  "wsl.onboarding.updateNexus": "Atjauniniet NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS ir gatavs.",
  "wsl.onboarding.installNexusIn": "Instalējiet NEXUS distribūcijā {{distro}}.",
  "wsl.onboarding.installNexus": "Instalējiet NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms NEXUS var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "NEXUS neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet NEXUS no jauna.",
  ...
  "help.tabs.introduction": "NEXUS Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna NEXUS versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu NEXUS komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (nexus.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, NEXUS vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "NEXUS darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist NEXUS serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt NEXUS saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā NEXUS izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai NEXUS sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet NEXUS tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot NEXUS",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko NEXUS versiju.",
