export const dict = {
  ...
  "desktop.menu.documentation": "NEXUS Документација",
  ...
  "desktop.menu.ariaLabel": "NEXUS мени",
  ...
  "desktop.recovery.loadFailed": "NEXUS не успеа да се вчита",
  "desktop.recovery.terminated": "Прозорецот NEXUS неочекувано заврши",
  "desktop.recovery.unresponsive": "NEXUS не реагира",
  ...
  "desktop.wsl.error.installNexus": "инсталацијата NEXUS не успеа",
  "desktop.wsl.error.alreadyAdded": "{{distro}} е веќе додаден",
  "desktop.wsl.error.nexusMissing": "nexus не е инсталиран во оваа дистрибуција",
  "desktop.wsl.error.nexusCannotRun": "nexus е инсталиран, но не може да се изврши",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS не е инсталиран во {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NEXUS ажурирањето е завршено, но {{distro}} сè уште известува {{installed}}; се очекува {{expected}}",
  ...
  "dialog.provider.nexus.note": "Курирани модели вклучувајќи Claude, GPT, Gemini и повеќе",
  "dialog.provider.nexus.tagline": "Сигурни оптимизирани модели",
  "dialog.provider.nexusGo.tagline": "Ниска цена претплата за секого",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатни модели обезбедени од NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Внесете го вашиот клуч {{provider}} API за да ја поврзете вашата сметка и да користите {{provider}} модели во NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen ви дава пристап до куриран сет на сигурни оптимизирани модели за агенти за кодирање.",
  "provider.connect.nexusZen.line2":
    "Со еден клуч API ќе добиете пристап до модели како што се Claude, GPT, Gemini, GLM и повеќе.",
  "provider.connect.nexusZen.visit.prefix": "Посетете",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": "да го соберете вашиот клуч API.",
  "provider.connect.oauth.code.visit.prefix": "Посетете",
  "provider.connect.oauth.code.visit.link": "оваа врска",
  "provider.connect.oauth.code.visit.suffix":
    "да го соберете вашиот код за авторизација за да ја поврзете вашата сметка и да користите {{provider}} модели во NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и внесете го кодот подолу за да ја поврзете вашата сметка и да користите {{provider}} модели во NEXUS.",
  ...
  "dialog.plugins.empty": "Приклучоци конфигурирани во nexus.json",
  ...
  "dialog.server.description": "Променете на кој NEXUS сервер се поврзува оваа апликација.",
  ...
  "wsl.onboarding.checkingNexus": "Се проверува NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Се проверува NEXUS во {{distro}}...",
  "wsl.onboarding.updatingNexus": "Се ажурира NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Се ажурира NEXUS во {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Ажурирајте NEXUS во {{distro}}.",
  "wsl.onboarding.updateNexus": "Ажурирај NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS е подготвен во {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS е подготвен.",
  "wsl.onboarding.installNexusIn": "Инсталирајте NEXUS во {{distro}}.",
  "wsl.onboarding.installNexus": "Инсталирај NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS не е инсталиран",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) е потребно пред NEXUS да може да додаде WSL сервер",
  "wsl.onboarding.wslUnavailable.title": "WSL недостапен",
  "wsl.onboarding.wslUnavailable.description": "NEXUS не можеше да го потврди WSL на оваа машина.",
  "wsl.onboarding.installWsl": "Инсталирај WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирајте го Windows за да завршите со инсталирањето WSL, а потоа повторно отворете NEXUS.",
  ...
  "help.tabs.introduction": "NEXUS Desktop сега е изграден околу картичките.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новата верзија на NEXUS ({{version}}) сега е достапна за инсталирање.",
  ...
  "error.page.report.prefix": "Ве молиме пријавете ја оваа грешка на тимот NEXUS",
  ...
  "error.chain.checkConfig": "Проверете ги имињата на давателот/моделот за конфигурација (nexus.json).",
  "error.chain.mcpFailed":
    "MCP серверот „{{name}}“ не успеа. Забелешка, NEXUS сè уште не поддржува автентикација MCP.",
  ...
  "sidebar.gettingStarted.line1": "NEXUS вклучува бесплатни модели за да можете веднаш да започнете.",
  ...
  "settings.desktop.wsl.description": "Стартувај го серверот NEXUS во WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете го јазикот на прикажување за NEXUS",
  ...
  "settings.general.row.appearance.description": "Приспособете како изгледа NEXUS на вашиот уред",
  "settings.general.row.colorScheme.title": "Шема на бои",
  "settings.general.row.colorScheme.description": "Изберете дали NEXUS ја следи системската, светла или темна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Приспособете како NEXUS е тематизирана.",
  ...
  "settings.updates.row.startup.description": "Автоматски проверувајте дали има ажурирања кога ќе се стартува NEXUS",
  ...
  "settings.updates.toast.latest.description": "Ја извршувате најновата верзија на NEXUS.",
