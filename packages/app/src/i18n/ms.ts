export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi NEXUS",
  ...
  "desktop.recovery.loadFailed": "NEXUS gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap NEXUS ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "NEXUS tidak memberi respons",
  ...
  "desktop.wsl.error.installNexus": "Pemasangan NEXUS gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.nexusMissing": "nexus tidak dipasang dalam distro ini",
  "desktop.wsl.error.nexusCannotRun": "nexus dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini NEXUS selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.nexus.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.nexus.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.nexusGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.nexusZen.visit.prefix": "Layari",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam NEXUS.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam nexus.json",
  ...
  "dialog.server.description": "Tukar pelayan NEXUS yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingNexus": "Sedang menyemak NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Sedang menyemak NEXUS dalam {{distro}}...",
  "wsl.onboarding.updatingNexus": "Sedang mengemas kini NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Sedang mengemas kini NEXUS dalam {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Kemas kini NEXUS dalam {{distro}}.",
  "wsl.onboarding.updateNexus": "Kemas kini NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS sedia digunakan.",
  "wsl.onboarding.installNexusIn": "Pasang NEXUS dalam {{distro}}.",
  "wsl.onboarding.installNexus": "Pasang NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum NEXUS boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "NEXUS tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula NEXUS.",
  ...
  "help.tabs.introduction": "NEXUS Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu NEXUS ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan NEXUS",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (nexus.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, NEXUS belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan NEXUS dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk NEXUS",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa NEXUS pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada NEXUS mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema NEXUS.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila NEXUS dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini NEXUS.",
