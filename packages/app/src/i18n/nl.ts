export const dict = {
  ...
  "desktop.menu.documentation": "NEXUS-documentatie",
  ...
  "desktop.recovery.loadFailed": "NEXUS kan niet worden geladen",
  "desktop.recovery.terminated": "Het NEXUS-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "NEXUS reageert niet",
  ...
  "desktop.wsl.error.installNexus": "Installatie van NEXUS is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.nexusMissing": "nexus is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.nexusCannotRun": "nexus is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De NEXUS-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.nexus.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.nexus.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.nexusGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in NEXUS te gebruiken.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.nexusZen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.nexusZen.visit.prefix": "Ga naar ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in NEXUS te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in NEXUS te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in nexus.json",
  ...
  "dialog.server.description": "Wijzig met welke NEXUS-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingNexus": "NEXUS controleren...",
  "wsl.onboarding.checkingNexusIn": "NEXUS controleren in {{distro}}...",
  "wsl.onboarding.updatingNexus": "NEXUS bijwerken...",
  "wsl.onboarding.updatingNexusIn": "NEXUS bijwerken in {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Werk NEXUS bij in {{distro}}.",
  "wsl.onboarding.updateNexus": "NEXUS bijwerken",
  "wsl.onboarding.nexusReadyIn": "NEXUS is gereed in {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS is klaar.",
  "wsl.onboarding.installNexusIn": "Installeer NEXUS in {{distro}}.",
  "wsl.onboarding.installNexus": "Installeer NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat NEXUS een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "NEXUS kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens NEXUS opnieuw.",
  ...
  "help.tabs.introduction": "NEXUS Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van NEXUS ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het NEXUS-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (nexus.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: NEXUS ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de NEXUS-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor NEXUS",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe NEXUS eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of NEXUS het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van NEXUS aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer NEXUS wordt gestart",
  ...
  "settings.updates.toast.latest.title": "NEXUS is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van NEXUS.",
