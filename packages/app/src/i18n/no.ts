...
export const dict = {
  ...
  "desktop.menu.documentation": "NEXUS-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "NEXUS-meny",
  ...
  "desktop.recovery.loadFailed": "NEXUS kunne ikke lastes inn",
  "desktop.recovery.terminated": "NEXUS-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "NEXUS svarer ikke",
  ...
  "desktop.wsl.error.installNexus": "Installasjonen av NEXUS mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.nexusMissing": "nexus er ikke installert i denne distribusjonen",
  "desktop.wsl.error.nexusCannotRun": "nexus er installert, men kunne ikke kjøres",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av NEXUS er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.nexus.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.nexus.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.nexusGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.nexusZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.nexusZen.visit.prefix": "Besøk ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i NEXUS.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i nexus.json",
  ...
  "dialog.server.description": "Bytt hvilken NEXUS-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av NEXUS ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til NEXUS-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (nexus.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at NEXUS ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør NEXUS-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for NEXUS",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan NEXUS ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om NEXUS skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i NEXUS.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når NEXUS starter",
  ...
  "settings.updates.toast.latest.title": "NEXUS er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av NEXUS.",
  ...
  "wsl.onboarding.checkingNexus": "Sjekker NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Sjekker NEXUS i {{distro}}...",
  "wsl.onboarding.updatingNexus": "Oppdaterer NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Oppdaterer NEXUS i {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Oppdater NEXUS i {{distro}}.",
  "wsl.onboarding.updateNexus": "Oppdater NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS er klar i {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS er klar.",
  "wsl.onboarding.installNexusIn": "Installer NEXUS i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før NEXUS kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "NEXUS kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter NEXUS på nytt.",
  ...
  "help.tabs.introduction": "NEXUS Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
