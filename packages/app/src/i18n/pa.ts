export const dict = {
  ...
  "desktop.menu.documentation": "NEXUS دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "NEXUS لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "NEXUS دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "NEXUS جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installNexus": "NEXUS دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.nexusMissing": "اس ڈسٹرو وچ nexus انسٹال نئیں اے",
  "desktop.wsl.error.nexusCannotRun": "nexus انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.nexusNotInstalled": "{{distro}} وچ NEXUS انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "NEXUS دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.nexus.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.nexus.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.nexusGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "NEXUS دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے NEXUS وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.nexusZen.visit.prefix": "ویکھو ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے NEXUS وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے NEXUS وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "nexus.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس NEXUS سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingNexus": "NEXUS چیک کر رئے آں...",
  "wsl.onboarding.checkingNexusIn": "{{distro}} چ NEXUS دی جانچ پڑتال...",
  "wsl.onboarding.updatingNexus": "NEXUS نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingNexusIn": "{{distro}} وچ NEXUS نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateNexusIn": "{{distro}} وچ NEXUS نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateNexus": "NEXUS اپ ڈیٹ کرو",
  "wsl.onboarding.nexusReadyIn": "NEXUS {{distro}} چ تیار اے۔",
  "wsl.onboarding.nexusReady": "NEXUS تیار اے۔",
  "wsl.onboarding.installNexusIn": "{{distro}} وچ NEXUS انسٹال کرو۔",
  "wsl.onboarding.installNexus": "NEXUS انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NEXUS دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "NEXUS ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر NEXUS دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "NEXUS Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NEXUS ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع NEXUS ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (nexus.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، NEXUS ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "NEXUS چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر NEXUS سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "NEXUS لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے NEXUS کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا NEXUS سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "NEXUS نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں NEXUS لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی NEXUS دا تازہ ترین ورژن چلا رئے او۔",
