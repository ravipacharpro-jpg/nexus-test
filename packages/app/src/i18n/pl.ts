export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja NEXUS",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać NEXUS",
  "desktop.recovery.terminated": "Okno NEXUS zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "NEXUS nie odpowiada",
  ...
  "desktop.wsl.error.installNexus": "Nie udało się zainstalować NEXUS",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.nexusMissing": "Program nexus nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.nexusCannotRun": "Program nexus jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja NEXUS została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.nexus.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.nexus.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.nexusGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.nexusZen.visit.prefix": "Odwiedź ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w NEXUS.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku nexus.json",
  ...
  "dialog.server.description": "Przełącz serwer NEXUS, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingNexus": "Sprawdzanie NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Sprawdzanie NEXUS w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingNexus": "Aktualizowanie NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Aktualizowanie NEXUS w dystrybucji {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Zaktualizuj NEXUS w dystrybucji {{distro}}.",
  "wsl.onboarding.updateNexus": "Zaktualizuj NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS jest gotowy.",
  "wsl.onboarding.installNexusIn": "Zainstaluj NEXUS w dystrybucji {{distro}}.",
  "wsl.onboarding.installNexus": "Zainstaluj NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim NEXUS będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "NEXUS nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz NEXUS.",
  ...
  "help.tabs.introduction": "NEXUS Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja NEXUS ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu NEXUS",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (nexus.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: NEXUS nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "NEXUS zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer NEXUS wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla NEXUS",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd NEXUS na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy NEXUS ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw NEXUS.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania NEXUS",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji NEXUS.",
