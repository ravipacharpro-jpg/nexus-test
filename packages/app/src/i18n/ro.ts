export const dict = {
  ...
  "desktop.menu.documentation": "Documentație NEXUS",
  ...
  "desktop.menu.ariaLabel": "Meniu NEXUS",
  ...
  "desktop.recovery.loadFailed": "NEXUS nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra NEXUS s-a închis neașteptat",
  "desktop.recovery.unresponsive": "NEXUS nu răspunde",
  ...
  "desktop.wsl.error.installNexus": "Instalarea NEXUS a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.nexusMissing": "nexus nu este instalat în această distribuție",
  "desktop.wsl.error.nexusCannotRun": "nexus este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea NEXUS s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.nexus.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.nexus.tagline": "Modele optimizate, fiabile",
  "dialog.provider.nexusGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.nexusZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.nexusZen.visit.prefix": "Vizitează",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în NEXUS.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în nexus.json",
  ...
  "dialog.server.description": "Schimbă serverul NEXUS la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingNexus": "Se verifică NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Se verifică NEXUS în {{distro}}...",
  "wsl.onboarding.updatingNexus": "Se actualizează NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Se actualizează NEXUS în {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Actualizează NEXUS în {{distro}}.",
  "wsl.onboarding.updateNexus": "Actualizează NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS este gata în {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS este gata.",
  "wsl.onboarding.installNexusIn": "Instalează NEXUS în {{distro}}.",
  "wsl.onboarding.installNexus": "Instalează NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca NEXUS să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "NEXUS nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide NEXUS.",
  ...
  "help.tabs.introduction": "NEXUS Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune NEXUS ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei NEXUS",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (nexus.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, NEXUS nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul NEXUS în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru NEXUS",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul NEXUS pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă NEXUS urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema NEXUS.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea NEXUS",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune NEXUS.",
