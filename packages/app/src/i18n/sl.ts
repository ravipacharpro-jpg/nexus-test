export const dict = {
  ...
  "desktop.menu.documentation": "NEXUS Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "NEXUS ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno NEXUS se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "NEXUS se ne odziva",
  ...
  "desktop.wsl.error.installNexus": "Namestitev NEXUS ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.nexusMissing": "nexus ni nameščen v tej distribuciji",
  "desktop.wsl.error.nexusCannotRun": "nexus je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev NEXUS je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.nexus.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.nexus.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.nexusGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.nexusZen.visit.prefix": "Obisk ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v NEXUS.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v nexus.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom NEXUS se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingNexus": "Preverjanje NEXUS ...",
  "wsl.onboarding.checkingNexusIn": "Preverjanje NEXUS v {{distro}} ...",
  "wsl.onboarding.updatingNexus": "Posodabljanje NEXUS ...",
  "wsl.onboarding.updatingNexusIn": "Posodabljanje NEXUS v {{distro}} ...",
  "wsl.onboarding.updateNexusIn": "Posodobite NEXUS v {{distro}}.",
  "wsl.onboarding.updateNexus": "Posodobite NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS je pripravljen v {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS je pripravljen.",
  "wsl.onboarding.installNexusIn": "Namestite NEXUS v {{distro}}.",
  "wsl.onboarding.installNexus": "Namestite NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko NEXUS doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "NEXUS ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite NEXUS.",
  ...
  "help.tabs.introduction": "NEXUS Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica NEXUS ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi NEXUS",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (nexus.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, NEXUS še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik NEXUS znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za NEXUS",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako NEXUS izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali NEXUS sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo NEXUS.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene NEXUS",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico NEXUS.",
