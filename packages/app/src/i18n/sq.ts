export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni NEXUS",
  ...
  "desktop.menu.ariaLabel": "Menuja NEXUS",
  ...
  "desktop.recovery.loadFailed": "NEXUS nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja NEXUS u mbyll papritur",
  "desktop.recovery.unresponsive": "NEXUS nuk po përgjigjet",
  ...
  "desktop.wsl.error.installNexus": "Instalimi i NEXUS dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.nexusMissing": "Nexus nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.nexusCannotRun": "Nexus është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i NEXUS përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.nexus.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.nexus.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.nexusGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.nexusZen.visit.prefix": "Vizitoni ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në NEXUS.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në nexus.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server NEXUS lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingNexus": "Po kontrollon NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Po kontrollon NEXUS në {{distro}}...",
  "wsl.onboarding.updatingNexus": "NEXUS po përditësohet...",
  "wsl.onboarding.updatingNexusIn": "Po përditëson NEXUS në {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Përditëso NEXUS në {{distro}}.",
  "wsl.onboarding.updateNexus": "Përditëso NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS është gati në {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS është gati.",
  "wsl.onboarding.installNexusIn": "Instaloni NEXUS në {{distro}}.",
  "wsl.onboarding.installNexus": "Instaloni NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se NEXUS të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "NEXUS nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap NEXUS.",
  ...
  "help.tabs.introduction": "NEXUS Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i NEXUS ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i NEXUS",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (nexus.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, NEXUS nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin NEXUS brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për NEXUS",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket NEXUS në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse NEXUS ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e NEXUS.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset NEXUS",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të NEXUS.",
