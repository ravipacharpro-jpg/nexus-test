export const dict = {
  ...
  "desktop.recovery.loadFailed": "NEXUS kunde inte läsas in",
  "desktop.recovery.terminated": "NEXUS-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "NEXUS svarar inte",
  ...
  "desktop.wsl.error.installNexus": "Installationen av NEXUS misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.nexusMissing": "nexus är inte installerat i den här distributionen",
  "desktop.wsl.error.nexusCannotRun": "nexus är installerat men kunde inte köras",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NEXUS-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.nexus.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.nexus.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.nexusGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  "provider.connect.nexusZen.line2":
    "Med en enda API-nyckel får du tillgång till modeller som Claude, GPT, Gemini, GLM och mer.",
  "provider.connect.nexusZen.visit.prefix": "Besök ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i NEXUS.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i nexus.json",
  ...
  "dialog.server.description": "Växla vilken NEXUS-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingNexus": "Kontrollerar NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Kontrollerar NEXUS i {{distro}}...",
  "wsl.onboarding.updatingNexus": "Uppdaterar NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Uppdaterar NEXUS i {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Uppdatera NEXUS i {{distro}}.",
  "wsl.onboarding.updateNexus": "Uppdatera NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS är redo i {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS är redo.",
  "wsl.onboarding.installNexusIn": "Installera NEXUS i {{distro}}.",
  "wsl.onboarding.installNexus": "Installera NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan NEXUS kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "NEXUS kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan NEXUS igen.",
  ...
  "help.tabs.introduction": "NEXUS Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av NEXUS ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till NEXUS-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (nexus.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, NEXUS stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör NEXUS-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för NEXUS",
  ...
  "settings.general.row.appearance.description": "Anpassa hur NEXUS ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om NEXUS följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa NEXUSs tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när NEXUS startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av NEXUS.",
