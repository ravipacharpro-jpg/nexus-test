export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด NEXUS ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง NEXUS หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "NEXUS ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installNexus": "การติดตั้ง NEXUS ล้มเหลว",
  "desktop.wsl.error.alreadyAdded": "เพิ่ม {{distro}} แล้ว",
  "desktop.wsl.error.nexusMissing": "ไม่ได้ติดตั้ง nexus ในดิสโทรนี้",
  "desktop.wsl.error.nexusCannotRun": "ติดตั้ง nexus แล้ว แต่ไม่สามารถเรียกใช้ได้",
  "desktop.wsl.error.nexusNotInstalled": "ไม่ได้ติดตั้ง NEXUS ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต NEXUS เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "dialog.provider.nexus.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.nexus.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.nexusGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย NEXUS",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน NEXUS",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน NEXUS",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน nexus.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ NEXUS ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingNexus": "กำลังตรวจสอบ NEXUS...",
  "wsl.onboarding.checkingNexusIn": "กำลังตรวจสอบ NEXUS ใน {{distro}}...",
  "wsl.onboarding.updatingNexus": "กำลังอัปเดต NEXUS...",
  "wsl.onboarding.updatingNexusIn": "กำลังอัปเดต NEXUS ใน {{distro}}...",
  "wsl.onboarding.updateNexusIn": "อัปเดต NEXUS ใน {{distro}}",
  "wsl.onboarding.updateNexus": "อัปเดต NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.nexusReady": "NEXUS พร้อมใช้งานแล้ว",
  "wsl.onboarding.installNexusIn": "ติดตั้ง NEXUS ใน {{distro}}",
  "wsl.onboarding.installNexus": "ติดตั้ง NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "ยังไม่ได้ติดตั้ง NEXUS",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ NEXUS จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "NEXUS ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด NEXUS อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ NEXUS Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ NEXUS ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม NEXUS",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (nexus.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า NEXUS ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "NEXUS รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ NEXUS ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ NEXUS",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ NEXUS บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ NEXUS ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ NEXUS",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ NEXUS เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน NEXUS เวอร์ชันล่าสุด",
