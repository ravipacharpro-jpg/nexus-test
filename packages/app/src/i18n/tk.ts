export const dict = {
  ...
  "desktop.menu.documentation": "NEXUS Resminamalar",
  ...
  "desktop.menu.ariaLabel": "NEXUS menýusy",
  ...
  "desktop.recovery.loadFailed": "NEXUS ýükläp bilmedi",
  "desktop.recovery.terminated": "NEXUS penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "NEXUS jogap berenok",
  ...
  "desktop.wsl.error.installNexus": "NEXUS gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.nexusMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.nexusCannotRun": "nexus guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "NEXUS täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.nexus.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.nexus.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.nexusGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "NEXUS tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we NEXUS-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  "provider.connect.nexusZen.line2":
    "Zekeje API açary bilen Claude, GPT, Gemini, GLM we başgalar ýaly modellere girip bilersiňiz.",
  "provider.connect.nexusZen.visit.prefix": "Sapar ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini NEXUS-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini NEXUS-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "nexus.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy NEXUS serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingNexus": "NEXUS barlamak ...",
  "wsl.onboarding.checkingNexusIn": "{{distro}} içinde NEXUS barlanýar...",
  "wsl.onboarding.updatingNexus": "NEXUS täzelenmek ...",
  "wsl.onboarding.updatingNexusIn": "{{distro}}-de NEXUS täzelenmek ...",
  "wsl.onboarding.updateNexusIn": "NEXUS-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateNexus": "NEXUS täzeläň",
  "wsl.onboarding.nexusReadyIn": "NEXUS {{distro}}-de taýýar.",
  "wsl.onboarding.nexusReady": "NEXUS taýýar.",
  "wsl.onboarding.installNexusIn": "{{distro}}-de NEXUS guruň.",
  "wsl.onboarding.installNexus": "NEXUS guruň",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) NEXUS WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "NEXUS bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra NEXUS açyň.",
  ...
  "help.tabs.introduction": "NEXUS Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin NEXUS ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy NEXUS toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (nexus.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, NEXUS entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "NEXUS serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "NEXUS üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "NEXUS enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "NEXUS ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "NEXUS-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "NEXUS işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "NEXUS-iň iň soňky wersiýasyny işleýärsiňiz.",
