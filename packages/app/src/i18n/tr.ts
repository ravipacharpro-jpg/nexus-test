...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "NEXUS yüklenemedi",
  "desktop.recovery.terminated": "NEXUS penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "NEXUS yanıt vermiyor",
  ...
  "desktop.wsl.error.installNexus": "NEXUS kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.nexusMissing": "nexus bu dağıtımda kurulu değil",
  "desktop.wsl.error.nexusCannotRun": "nexus kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "NEXUS güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.nexus.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.nexus.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.nexusGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "NEXUS tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve NEXUS'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.nexusZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak NEXUS'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak NEXUS'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler nexus.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi NEXUS sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingNexus": "NEXUS kontrol ediliyor...",
  "wsl.onboarding.checkingNexusIn": "{{distro}} içinde NEXUS kontrol ediliyor...",
  "wsl.onboarding.updatingNexus": "NEXUS güncelleniyor...",
  "wsl.onboarding.updatingNexusIn": "{{distro}} içinde NEXUS güncelleniyor...",
  "wsl.onboarding.updateNexusIn": "{{distro}} içindeki NEXUS'u güncelleyin.",
  "wsl.onboarding.updateNexus": "NEXUS'u güncelle",
  "wsl.onboarding.nexusReadyIn": "{{distro}} içinde NEXUS hazır.",
  "wsl.onboarding.nexusReady": "NEXUS hazır.",
  "wsl.onboarding.installNexusIn": "NEXUS'u {{distro}} içine kurun.",
  "wsl.onboarding.installNexus": "NEXUS'u kur",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NEXUS'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "NEXUS bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından NEXUS'u tekrar açın.",
  ...
  "help.tabs.introduction": "NEXUS Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NEXUS'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı NEXUS ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (nexus.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: NEXUS henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "NEXUS Masaüstü",
  ...
  "settings.desktop.wsl.description": "NEXUS sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "NEXUS'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "NEXUS'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "NEXUS'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "NEXUS'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "NEXUS başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "NEXUS'un en son sürümünü kullanıyorsunuz.",
