export const dict = {
  ...
  "desktop.menu.documentation": "Документація NEXUS",
  ...
  "desktop.menu.ariaLabel": "Меню NEXUS",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити NEXUS",
  "desktop.recovery.terminated": "Роботу вікна NEXUS несподівано завершено",
  "desktop.recovery.unresponsive": "NEXUS не відповідає",
  ...
  "desktop.wsl.error.installNexus": "Не вдалося встановити NEXUS",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.nexusMissing": "nexus не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.nexusCannotRun": "nexus встановлено, але його не вдалося запустити",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення NEXUS завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.nexus.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.nexus.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.nexusGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від NEXUS",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  "provider.connect.nexusZen.line2":
    "З одним ключем API ви отримаєте доступ до таких моделей, як Claude, GPT, Gemini, GLM та інших.",
  "provider.connect.nexusZen.visit.prefix": "Відвідайте ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у NEXUS.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в nexus.json",
  ...
  "dialog.server.description": "Перемкніть сервер NEXUS, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingNexus": "Перевірка NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Перевірка NEXUS у {{distro}}...",
  "wsl.onboarding.updatingNexus": "Оновлення NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Оновлення NEXUS у {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Оновіть NEXUS у {{distro}}.",
  "wsl.onboarding.updateNexus": "Оновити NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS готовий до роботи у {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS готовий до роботи.",
  "wsl.onboarding.installNexusIn": "Встановіть NEXUS у {{distro}}.",
  "wsl.onboarding.installNexus": "Встановити NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в NEXUS потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "NEXUS не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте NEXUS.",
  ...
  "help.tabs.introduction": "NEXUS Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія NEXUS ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді NEXUS",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (nexus.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, NEXUS ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер NEXUS всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу NEXUS",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд NEXUS на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи NEXUS використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему NEXUS.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску NEXUS",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію NEXUS.",
