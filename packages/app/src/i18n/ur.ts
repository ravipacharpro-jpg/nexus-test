export const dict = {
  ...
  "desktop.menu.documentation": "NEXUS دستاویزات",
  ...
  "desktop.menu.ariaLabel": "NEXUS مینو",
  ...
  "desktop.recovery.loadFailed": "NEXUS لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "NEXUS ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "NEXUS جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installNexus": "NEXUS کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.nexusMissing": "اس ڈسٹری بیوشن میں nexus انسٹال نہیں ہے",
  "desktop.wsl.error.nexusCannotRun": "nexus انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.nexusNotInstalled": "{{distro}} میں NEXUS انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "NEXUS کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.nexus.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.nexus.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.nexusGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "NEXUS کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور NEXUS میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  "provider.connect.nexusZen.line2":
    "ایک واحد API کلید کے ساتھ آپ Claude، GPT، Gemini، GLM اور مزید ماڈلز تک رسائی حاصل کریں گے۔",
  "provider.connect.nexusZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور NEXUS میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور NEXUS میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "nexus.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس NEXUS سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingNexus": "NEXUS چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingNexusIn": "{{distro}} میں NEXUS چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingNexus": "NEXUS کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingNexusIn": "{{distro}} میں NEXUS کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateNexusIn": "{{distro}} میں NEXUS کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateNexus": "NEXUS کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.nexusReadyIn": "NEXUS {{distro}} میں تیار ہے۔",
  "wsl.onboarding.nexusReady": "NEXUS تیار ہے۔",
  "wsl.onboarding.installNexusIn": "{{distro}} میں NEXUS انسٹال کریں۔",
  "wsl.onboarding.installNexus": "NEXUS انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ NEXUS WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "NEXUS اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر NEXUS کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "NEXUS Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NEXUS ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم NEXUS ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (nexus.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، NEXUS ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "NEXUS میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "NEXUS ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر NEXUS سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "NEXUS کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر NEXUS کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا NEXUS سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "NEXUS کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "NEXUS لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ NEXUS کا تازہ ترین ورژن چلا رہے ہیں۔",
