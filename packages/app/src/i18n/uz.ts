export const dict = {
  ...
  "desktop.menu.documentation": "NEXUS hujjatlari",
  ...
  "desktop.menu.ariaLabel": "NEXUS menyusi",
  ...
  "desktop.recovery.loadFailed": "NEXUS yuklanmadi",
  "desktop.recovery.terminated": "NEXUS oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "NEXUS javob bermayapti",
  ...
  "desktop.wsl.error.installNexus": "NEXUS oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.nexusMissing": "Nexus ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.nexusCannotRun": "nexus o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "NEXUS yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.nexus.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.nexus.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.nexusGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "NEXUS tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va NEXUS’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.nexusZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va NEXUS da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va NEXUS da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "nexus.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi NEXUS serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingNexus": "NEXUS tekshirilmoqda...",
  "wsl.onboarding.checkingNexusIn": "NEXUS {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingNexus": "NEXUS yangilanmoqda...",
  "wsl.onboarding.updatingNexusIn": "NEXUS {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateNexusIn": "NEXUS-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateNexus": "NEXUS-ni yangilang",
  "wsl.onboarding.nexusReadyIn": "NEXUS {{distro}} da tayyor.",
  "wsl.onboarding.nexusReady": "NEXUS tayyor.",
  "wsl.onboarding.installNexusIn": "NEXUS-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installNexus": "NEXUS-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NEXUS WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "NEXUS WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra NEXUS-ni qayta oching.",
  ...
  "help.tabs.introduction": "NEXUS Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NEXUS ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida NEXUS jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (nexus.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, NEXUS hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "NEXUS bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi NEXUS serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "NEXUS uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "NEXUS qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "NEXUS tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "NEXUS mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "NEXUS ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz NEXUS oxirgi versiyasini ishga tushiryapsiz.",
