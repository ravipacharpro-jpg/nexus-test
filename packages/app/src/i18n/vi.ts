export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu NEXUS",
  ...
  "desktop.recovery.loadFailed": "Không tải được NEXUS",
  "desktop.recovery.terminated": "Cửa sổ NEXUS đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "NEXUS không phản hồi",
  ...
  "desktop.wsl.error.installNexus": "Không cài đặt được NEXUS",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.nexusMissing": "nexus chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.nexusCannotRun": "nexus đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.nexusNotInstalled": "NEXUS chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật NEXUS nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.nexus.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.nexus.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.nexusGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do NEXUS cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong NEXUS.",
  ...
  "provider.connect.nexusZen.line1":
    "NEXUS Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.nexusZen.visit.prefix": "Truy cập ",
  "provider.connect.nexusZen.visit.link": "nexus.ai/zen",
  "provider.connect.nexusZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong NEXUS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong NEXUS.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong nexus.json",
  ...
  "dialog.server.description": "Chuyển máy chủ NEXUS mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingNexus": "Đang kiểm tra NEXUS...",
  "wsl.onboarding.checkingNexusIn": "Đang kiểm tra NEXUS trong {{distro}}...",
  "wsl.onboarding.updatingNexus": "Đang cập nhật NEXUS...",
  "wsl.onboarding.updatingNexusIn": "Đang cập nhật NEXUS trong {{distro}}...",
  "wsl.onboarding.updateNexusIn": "Cập nhật NEXUS trong {{distro}}.",
  "wsl.onboarding.updateNexus": "Cập nhật NEXUS",
  "wsl.onboarding.nexusReadyIn": "NEXUS đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.nexusReady": "NEXUS đã sẵn sàng.",
  "wsl.onboarding.installNexusIn": "Cài đặt NEXUS trong {{distro}}.",
  "wsl.onboarding.installNexus": "Cài đặt NEXUS",
  ...
  "wsl.onboarding.distroStatus.nexusMissing": "NEXUS chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi NEXUS có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "NEXUS không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại NEXUS.",
  ...
  "help.tabs.introduction": "NEXUS Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của NEXUS ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm NEXUS",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (nexus.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: NEXUS chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "NEXUS bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ NEXUS bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho NEXUS",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của NEXUS trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem NEXUS tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của NEXUS.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi NEXUS khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của NEXUS.",
