...
const GLOBAL_STORAGE = "nexus.global.dat"
const WINDOW_STORAGE = "nexus.window"
const LOCAL_PREFIX = "nexus."
...
function workspaceStorage(dir: string) {
  ...
  return `nexus.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `nexus.draft.${head}.${sum}.dat`
}
