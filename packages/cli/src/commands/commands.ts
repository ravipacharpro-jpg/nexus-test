...
declare const NEXUS_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof NEXUS_CLI_NAME === "string" ? NEXUS_CLI_NAME : "nexus", {
  description: "NEXUS 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
