...
import { compile, emitEffectImported, emitPromise, write } from "@nexus-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "NEXUSEventEncoded",
              import: 'import type { NEXUSEventEncoded } from "@nexus-ai/protocol/groups/event"',
            },
          },
        }),
