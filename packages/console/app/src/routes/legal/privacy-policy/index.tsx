...
export default function PrivacyPolicy() {
  ...
  return (
    <main data-page="legal">
      ...
      <Meta name="description" content="NEXUS privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At NEXUS, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of NEXUS is at all times subject to our Terms of Use,{" "}
                <a href={language.route("/legal/terms-of-service")}>https://nexus.ai/legal/terms-of-service</a>,
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the NEXUS website, by sending you
              ...
              <ul>
                <li>
                  ...
                  sending you information about NEXUS.
                </li>
              ...
              <p>
                ...
                you, NEXUS or another party; enforcing any agreements with you; responding to claims that any posting
