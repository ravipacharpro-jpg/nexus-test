...
import compareVideo from "../../asset/lander/nexus-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/nexus-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="nexus:auth" content={loggedin() ? "true" : "false"} />
