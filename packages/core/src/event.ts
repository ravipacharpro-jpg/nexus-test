...
import type { Data, Definition, Payload } from "@nexus-ai/schema/event"
...
import { Durable } from "@nexus-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@nexus-ai/schema/event").ID
export type { Data, Definition, Payload } from "@nexus-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@nexus/Event") {}
