...
import { Entry, FileSystem, FindInput, Match } from "@nexus-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@nexus-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@nexus/v2/FileSystem") {}
