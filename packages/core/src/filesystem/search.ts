...
export class Service extends Context.Service<Service, Interface>()("@nexus/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.NEXUS_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
