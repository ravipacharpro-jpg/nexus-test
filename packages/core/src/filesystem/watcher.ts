...
import { FileSystemWatcher } from "@nexus-ai/schema/filesystem-watcher"
...
declare const NEXUS_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof NEXUS_LIBC === "undefined" ? undefined : NEXUS_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@nexus/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.NEXUS_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.NEXUS_EXPERIMENTAL_FILEWATCHER)) {
