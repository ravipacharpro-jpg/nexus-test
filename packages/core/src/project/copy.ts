...
import { Event } from "@nexus-ai/schema/project-directories"
import { ProjectCopy } from "@nexus-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@nexus/ProjectCopy") {}
