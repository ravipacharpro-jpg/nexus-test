...
import type { EffectDrizzleSqlite } from "@nexus-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@nexus/ProjectDirectories") {}
