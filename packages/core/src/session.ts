...
import { ListAnchor } from "@nexus-ai/schema/session"
...
import { SessionDurable } from "@nexus-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@nexus/v2/Session") {}
