...
export class Service extends Context.Service<Service, Interface>()("@nexus/v2/SkillDiscovery") {}
            ...
            Effect.gen(function* () {
              ...
              if (version === undefined || current === version) {
                ...
                yield* Effect.gen(function* () {
                  ...
                  if (!exists) return
                  yield* fs.writeFileString(path.join(staging, ".nexus-version"), version)
