...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@nexus-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@nexus/v2/ToolRegistry") {}
