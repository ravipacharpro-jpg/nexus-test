...
const releaseId = process.env.NEXUS_RELEASE
if (!releaseId) throw new Error("NEXUS_RELEASE is required")

const version = process.env.NEXUS_VERSION
if (!version) throw new Error("NEXUS_VERSION is required")
...
const macxTarGz = "nexus-desktop-mac-x64.app.tar.gz"
const macaTarGz = "nexus-desktop-mac-arm64.app.tar.gz"
