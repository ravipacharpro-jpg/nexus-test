export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የNEXUS ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከNEXUS ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
