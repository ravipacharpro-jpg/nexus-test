export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse NEXUS uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "NEXUS'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „nexus” kasutamiseks taaskäivitage terminal.",
