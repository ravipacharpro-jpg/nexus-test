export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo NEXUSn uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "NEXUSn versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää NEXUSn uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'nexus'-komentoa.",
