export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van NEXUS",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van NEXUS is gedownload. Wil je deze installeren en NEXUS opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'nexus' te gebruiken.",
