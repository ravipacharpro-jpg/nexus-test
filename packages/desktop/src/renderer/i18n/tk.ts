export const dict = {
  ...
  "desktop.updater.none.message": "NEXUS-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "NEXUS-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'nexus' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
