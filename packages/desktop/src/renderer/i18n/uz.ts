export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon NEXUS ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "NEXUSning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'nexus' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
