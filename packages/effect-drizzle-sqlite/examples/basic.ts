...
class Database extends Context.Service<Database, DatabaseShape>()("@nexus/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@nexus/example/UserStore") {
