...
export const TypeId: TypeId = "~@nexus-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@nexus-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@nexus-ai/effect-sqlite-node/NodeSqliteClient")
