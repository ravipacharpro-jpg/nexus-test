import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@nexus-ai/sdk/v2"
import { SessionTurn } from "@nexus-ai/session-ui/session-turn"
import { SessionReview } from "@nexus-ai/session-ui/session-review"
import { DataProvider } from "@nexus-ai/session-ui/context"
import { FileComponentProvider } from "@nexus-ai/ui/context/file"
import { WorkerPoolProvider } from "@nexus-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@nexus-ai/ui/logo"
import { IconButton } from "@nexus-ai/ui/icon-button"
import { ProviderIcon } from "@nexus-ai/ui/provider-icon"
import { iife } from "@nexus-ai/core/util/iife"
import { Binary } from "@nexus-ai/core/util/binary"
import { NamedError } from "@nexus-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@nexus-ai/ui/tabs"
import { MessageNav } from "@nexus-ai/session-ui/message-nav"
import { FileSSR } from "@nexus-ai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@nexus-ai/session-ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/nexus-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | NEXUS</Title>
              </Show>
              <Meta name="description" content="nexus - The AI coding agent built for the terminal." />
