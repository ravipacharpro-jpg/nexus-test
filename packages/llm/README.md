...
Schema-first LLM core for nexus. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@nexus-ai/llm"
import { OpenAI } from "@nexus-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@nexus-ai/llm/providers"
