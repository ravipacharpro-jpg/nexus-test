...
Practical reference for the current tool-migration state in `packages/nexus`.
...
Tool tests should use the existing Effect helpers in `packages/nexus/test/lib/effect.ts`:
