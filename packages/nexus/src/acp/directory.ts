...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@nexus/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@nexus/ACPDirectory") {}
