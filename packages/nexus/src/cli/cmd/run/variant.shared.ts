...
//
// The saved variant persists across sessions in ~/.local/state/nexus/model.json
...
class Service extends Context.Service<Service, VariantService>()("@nexus/RunVariant") {}
