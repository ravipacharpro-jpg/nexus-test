...
import { EventSequenceTable, EventTable } from "@nexus-ai/core/event/sql"
...
import { WorkspaceEvent } from "@nexus-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@nexus/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        NEXUS_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        NEXUS_WORKSPACE_ID: config.id,
        NEXUS_EXPERIMENTAL_WORKSPACES: "true",
