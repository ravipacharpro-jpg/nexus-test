 ...
 *   "@nexus/ServerAuthConfig",
 *   {
 *     password: Config.string("NEXUS_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("NEXUS_SERVER_USERNAME").pipe(Config.withDefault("nexus")),
 *   },
 * ) {}
 *
