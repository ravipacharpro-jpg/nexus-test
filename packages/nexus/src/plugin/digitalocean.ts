...
import type { Model } from "@nexus-ai/sdk/v2"
import { InstallationVersion } from "@nexus-ai/core/installation/version"
import { OauthCallbackPage } from "@nexus-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. NEXUS will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
