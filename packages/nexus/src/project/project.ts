...
import { ProjectDirectoryTable, ProjectTable } from "@nexus-ai/core/project/sql"
import { ProjectDirectories } from "@nexus-ai/core/project/directories"
...
import { which } from "@nexus-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@nexus/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.NEXUS_FAKE_VCS)
