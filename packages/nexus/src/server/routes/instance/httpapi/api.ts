...
import { makeApi } from "@nexus-ai/protocol/api"
import { LocationMiddleware } from "@nexus-ai/server/location"
import { SessionLocationMiddleware } from "@nexus-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("nexus-root")
...
export const InstanceHttpApi = HttpApi.make("nexus-instance")
...
export const NEXUSHttpApi = HttpApi.make("nexus")
