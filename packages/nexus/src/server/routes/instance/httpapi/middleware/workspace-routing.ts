...
>()("@nexus/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@nexus/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.NEXUS_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.NEXUS_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-nexus-directory"] || process.cwd()
}
