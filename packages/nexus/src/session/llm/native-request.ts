import type { JsonSchema, LLMRequest, ProviderMetadata } from "@nexus-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@nexus-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @nexus-ai/llm request objects from nexus's session/AI SDK-shaped data.
  return LLM.request({
