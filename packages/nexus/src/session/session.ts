...
import { locationServiceMapLayer } from "@nexus-ai/core/location-services"
...
import { PartTable, SessionTable } from "@nexus-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@nexus-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".nexus", "plans")
