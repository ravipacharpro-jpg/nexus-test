...
import type * as SDK from "@nexus-ai/sdk/v2"
...
import { SessionShareTable } from "@nexus-ai/core/share/sql"
...
const disabled = process.env["NEXUS_DISABLE_SHARE"] === "true" || process.env["NEXUS_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@nexus/ShareNext") {}
