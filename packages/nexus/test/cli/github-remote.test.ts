...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/nexus.git")).toEqual({ owner: "sst", repo: "nexus" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/nexus")).toEqual({ owner: "sst", repo: "nexus" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/nexus.git")).toEqual({ owner: "sst", repo: "nexus" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/nexus")).toEqual({ owner: "sst", repo: "nexus" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/nexus.git")).toEqual({ owner: "sst", repo: "nexus" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/nexus")).toEqual({ owner: "sst", repo: "nexus" })
})
