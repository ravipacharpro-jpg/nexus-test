...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders NEXUS_CALLER", () => {
    process.env["NEXUS_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode NEXUS_CALLER", () => {
    process.env["NEXUS_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown NEXUS_CALLER", () => {
    process.env["NEXUS_CALLER"] = "unknown"
