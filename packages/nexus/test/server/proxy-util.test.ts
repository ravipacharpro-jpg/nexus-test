...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips nexus-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-nexus-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-nexus-directory")).toBeNull()
      expect(result.get("x-nexus-workspace")).toBeNull()
