...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips nexus-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-nexus-directory"]).toBeUndefined()
      expect(forwarded["x-nexus-workspace"]).toBeUndefined()
