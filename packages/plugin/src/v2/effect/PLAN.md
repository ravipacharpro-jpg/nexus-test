...
- Effect plugins import `@nexus-ai/plugin/v2/effect`, not `@nexus-ai/core`.
- Public domain values use generated `@nexus-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@nexus-ai/plugin/v2/effect`.
