# NEXUS V2 Promise Plugin API

The Promise plugin API is the async/await equivalent of `@nexus-ai/plugin/v2/effect`. It grants plugins the same two in-process capabilities:
