...
import type { Definition } from "@nexus-ai/schema/event"
...
export const NEXUSEvent = event.schema
export type NEXUSEvent = typeof NEXUSEvent.Type
export type NEXUSEventEncoded = typeof NEXUSEvent.Encoded
