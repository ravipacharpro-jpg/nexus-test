import { NEXUS } from "@nexus-ai/client/effect"
...
import { createEmbeddedRoutes } from "@nexus-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("NEXUS.create")(function* () {
  ...
  const client = yield* NEXUS.make({ baseUrl: "http://nexus.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@nexus-ai/sdk-next/NEXUS") {}
