...
const en = {
  "app.title": "AI Model Usage Rankings | NEXUS Data",
  "app.description":
    "Explore NEXUS usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "NEXUS Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star NEXUS on GitHub",
  "header.github": "GitHub",
  "header.tryNEXUS": "Try NEXUS",
  ...
  "home.topModelsDescription": "Usage of models across NEXUS.",
  ...
  "home.uniqueUsersDescription": "Daily unique NEXUS users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | NEXUS Data",
  "lab.description":
    "Compare {{lab}} models used in NEXUS, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent NEXUS usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in NEXUS",
  ...
  "lab.shareOfUsage": "{{share}} of recent NEXUS usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | NEXUS Data",
  "model.description":
    "View {{model}} NEXUS usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. NEXUS usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's NEXUS usage",
  "model.ranked": "Ranked #{{rank}} across last week's NEXUS usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No NEXUS usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no NEXUS usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "NEXUS model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No NEXUS geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent NEXUS token volume.",
