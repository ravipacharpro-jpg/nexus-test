export const dict = {
  "app.title": "Ranking de uso de modelos de IA | NEXUS Data",
  "app.description":
    "Explore o uso do NEXUS em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do NEXUS Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao NEXUS no GitHub",
  "header.github": "GitHub",
  "header.tryNEXUS": "Experimente o NEXUS",
  ...
  "footer.homeAria": "Início do NEXUS",
  ...
  "modal.title": "Newsletter do NEXUS",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no NEXUS.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do NEXUS por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | NEXUS Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no NEXUS, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do NEXUS.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no NEXUS",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do NEXUS",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do NEXUS nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | NEXUS Data",
  "model.description":
    "Veja dados de uso de {{model}} no NEXUS, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no NEXUS aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do NEXUS da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do NEXUS da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do NEXUS na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do NEXUS, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do NEXUS.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do NEXUS na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do NEXUS na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do NEXUS.",
  ...
  "model.geoDescription": "Tokens do modelo NEXUS usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do NEXUS correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do NEXUS.",
