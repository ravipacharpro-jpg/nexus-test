export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | NEXUS Data",
  "app.description":
    "Esplora l'utilizzo di NEXUS nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo NEXUS Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a NEXUS su GitHub",
  "header.github": "GitHub",
  "header.tryNEXUS": "Prova NEXUS",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in NEXUS.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di NEXUS per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | NEXUS Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in NEXUS, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di NEXUS.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in NEXUS",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di NEXUS",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token NEXUS negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | NEXUS Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in NEXUS, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di NEXUS appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo NEXUS della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo NEXUS della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di NEXUS nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di NEXUS, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di NEXUS.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token NEXUS nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di NEXUS nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione NEXUS.",
  ...
  "model.geoDescription": "Token del modello NEXUS usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica NEXUS corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token NEXUS.",
