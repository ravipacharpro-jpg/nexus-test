export const dict = {
  "app.title": "Rankingi użycia modeli AI | NEXUS Data",
  "app.description":
    "Przeglądaj użycie NEXUS w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny NEXUS Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę NEXUS na GitHub",
  "header.github": "GitHub",
  "header.tryNEXUS": "Wypróbuj NEXUS",
  ...
  "footer.homeAria": "Strona główna NEXUS",
  ...
  "home.topModelsDescription": "Użycie modeli w NEXUS.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy NEXUS według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | NEXUS Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w NEXUS, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia NEXUS.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w NEXUS",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia NEXUS",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów NEXUS z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | NEXUS Data",
  "model.description":
    "Zobacz dane użycia {{model}} w NEXUS, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie NEXUS pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu NEXUS z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu NEXUS z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia NEXUS w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny NEXUS, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia NEXUS.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów NEXUS w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy NEXUS w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji NEXUS.",
  ...
  "model.geoDescription": "Tokeny modelu NEXUS użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne NEXUS nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów NEXUS.",
