export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | NEXUS Data",
  "app.description":
    "NEXUS kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde NEXUS Data logosu",
  ...
  "header.githubAria": "GitHub'da NEXUS'a yıldız ver",
  "header.github": "GitHub",
  "header.tryNEXUS": "NEXUS'u dene",
  ...
  "footer.homeAria": "NEXUS ana sayfası",
  ...
  "home.topModelsDescription": "NEXUS genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz NEXUS kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | NEXUS Data",
  "lab.description":
    "NEXUS'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son NEXUS kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "NEXUS'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son NEXUS kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük NEXUS token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | NEXUS Data",
  "model.description":
    "{{model}} için NEXUS kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda NEXUS kullanımı görünür.",
  "model.unranked": "Geçen haftaki NEXUS kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki NEXUS kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde NEXUS kullanımı yok.",
  ...
  "model.overviewDescription": "Son NEXUS tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz NEXUS kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük NEXUS token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz NEXUS kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama NEXUS oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan NEXUS model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen NEXUS coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son NEXUS token hacmine göre yakındaki modeller.",
