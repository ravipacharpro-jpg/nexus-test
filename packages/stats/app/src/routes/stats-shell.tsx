import nexusWordmarkDark from "../asset/logo-ornate-dark.svg"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://nexus.ai/">
            <strong>{i18n.t("header.tryNEXUS")}</strong>
          </a>
          <button
...
function NEXUSMark() {
  return (
    <svg data-slot="nexus-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://nexus.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://nexus.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@nexus.ai", label: i18n.t("footer.contact") },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://nexus.ai" aria-label={i18n.t("footer.homeAria")}>
          <NEXUSMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={nexusWordmarkDark} alt="NEXUS" />
          <button
