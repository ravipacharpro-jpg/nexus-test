...
import defaultSoundPath from "@nexus-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@nexus-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@nexus-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@nexus-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@nexus-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@nexus-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_PACK_ID = "nexus.default"
