...
import { useBindings, useNexusModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useNexusModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.NEXUS_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
