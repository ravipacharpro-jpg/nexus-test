...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "NEXUS.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/nexus/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/nexus (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/nexus/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/nexus/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const NEXUS_DB|NEXUS_DB|NEXUS_DEV|Global\\.Path\\.data|data =" in packages/nexus/src (115 matches)',
  },
] as const
