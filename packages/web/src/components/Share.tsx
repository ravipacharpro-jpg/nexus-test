...
import { IconNexus } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "nexus/session/message-v2"
import type { Message } from "nexus/session/message"
import type { Session } from "nexus/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.nexus_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.nexus_name}>
                    <IconNexus width={16} height={16} />
                  </div>
