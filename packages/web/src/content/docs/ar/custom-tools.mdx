...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في nexus.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في nexus مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.nexus/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/nexus/tools/`.
