---
title: TUI
description: استخدام واجهة المستخدم TUI في NEXUS.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر NEXUS واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل NEXUS إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة NEXUS في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى NEXUS. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من NEXUS. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `nexus.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار NEXUS بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `nexus.default`.
