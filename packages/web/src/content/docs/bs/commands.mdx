...
Kreiraj `.nexus/commands/test.md`:
...
Možete dodati prilagođene komande kroz NEXUS konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom NEXUS [config](/docs/config):
...
- Globalno: `~/.config/nexus/commands/`
- Po projektu: `.nexus/commands/`
...
NEXUS uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
