---
title: LSP serveri
description: NEXUS se integriše sa vašim LSP serverima.
---

NEXUS se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

NEXUS dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `NEXUS_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i nexus otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj nexus konfiguraciji.
