---
title: TUI
description: Korištenje korisničkog interfejsa NEXUS terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

NEXUS pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje NEXUS pokreće TUI za trenutni direktorij.
...
Kada koristite NEXUS TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u NEXUS. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz NEXUS. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `nexus.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo NEXUS čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `nexus.default`.
