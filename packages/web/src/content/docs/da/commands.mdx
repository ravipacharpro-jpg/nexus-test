...
Du kan tilføje brugerdefinerede kommandoer gennem NEXUS-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din NEXUS [config](/docs/config):
...
- Globalt: `~/.config/nexus/commands/`
- Pr. projekt: `.nexus/commands/`
...
nexus indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
