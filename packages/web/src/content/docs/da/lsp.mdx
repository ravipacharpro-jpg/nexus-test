---
title: LSP-servere
description: NEXUS integreres med dine LSP-servere.
---

NEXUS kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

NEXUS leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `NEXUS_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og nexus åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din nexus-konfiguration.
