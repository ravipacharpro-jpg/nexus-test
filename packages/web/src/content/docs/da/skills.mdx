...
Agentferdigheter lar NEXUS oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går NEXUS opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
NEXUS viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `nexus.json`:
