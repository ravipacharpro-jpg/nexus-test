---
title: Zen
description: Udvalgt liste over modeller leveret af NEXUS.
---
...
NEXUS Zen er en liste over testede og verificerede modeller leveret af NEXUS-teamet.

Zen fungerer som enhver anden udbyder i NEXUS. Du logger ind på NEXUS Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med NEXUS.
:::
...
NEXUS Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

NEXUS Zen fungerer som enhver anden udbyder i NEXUS.

1. Du logger ind på **<a href={console}>NEXUS Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger NEXUS Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din NEXUS-konfiguration
bruger formatet `nexus/<model-id>`. For eksempel ville du for GPT 5.5
bruge `nexus/gpt-5.5` i din konfiguration.
...
Du vil måske bemærke [lavprismodeller](/docs/config/#models), såsom Haiku, Nano eller Flash, i din brugshistorik. NEXUS bruger disse modeller til at generere sessionstitler.
...
- MiMo-V2.5 Free er tilgængelig på NEXUS i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Hy3 Free er tilgængelig på NEXUS i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på NEXUS i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3.5 Lightning Free er tilgængelig på NEXUS i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på NEXUS i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Ox Alpha Free er en stealth-model, som er gratis på NEXUS i en begrænset periode. Udbyderen følger en nul-opbevaringspolitik og bruger ikke dine data til at træne modeller.
- Muse Spark 1.2 Contributor Free er tilgængelig på NEXUS i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med NEXUS også.
