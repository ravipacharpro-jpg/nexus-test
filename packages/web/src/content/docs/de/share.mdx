---
title: Teilen
description: Teile NEXUS-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu NEXUS-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht NEXUS Folgendes:
...
NEXUS hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt NEXUS den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`nexus.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du nexus in deiner Organisation einsetzt.
