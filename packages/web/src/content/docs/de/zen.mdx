---
title: Zen
description: Kuratierte Modellliste direkt von NEXUS.
---
...
NEXUS Zen ist eine Liste von getesteten und verifizierten Modellen, die vom NEXUS-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in NEXUS. Du meldest dich bei NEXUS Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um NEXUS zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit NEXUS funktionieren.
:::
...
NEXUS Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

NEXUS Zen funktioniert wie jeder andere Provider in NEXUS.

1. Du meldest dich bei **<a href={console}>NEXUS Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst NEXUS Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner NEXUS-Konfiguration verwendet das Format `nexus/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `nexus/gpt-5.5` in deiner Konfiguration verwenden.
...
Möglicherweise siehst du [kostengünstige Modelle](/docs/config/#models) wie Haiku, Nano oder Flash in deinem Nutzungsverlauf. NEXUS verwendet diese Modelle, um Session-Titel zu generieren.
...
- MiMo-V2.5 Free ist für begrenzte Zeit auf NEXUS verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Hy3 Free ist für begrenzte Zeit auf NEXUS verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf NEXUS verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3.5 Lightning Free ist für begrenzte Zeit auf NEXUS verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf NEXUS verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Ox Alpha Free ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf NEXUS verfügbar ist. Der Anbieter befolgt eine Zero-Retention-Richtlinie und verwendet deine Daten nicht zum Trainieren von Modellen.
- Muse Spark 1.2 Contributor Free ist für begrenzte Zeit auf NEXUS verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben NEXUS Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit NEXUS auch jeden anderen Provider zu verwenden.
