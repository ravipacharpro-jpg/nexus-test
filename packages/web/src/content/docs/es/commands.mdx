...
Puede agregar comandos personalizados a través de la configuración NEXUS o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su NEXUS [config](/docs/config):
...
nexus incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
