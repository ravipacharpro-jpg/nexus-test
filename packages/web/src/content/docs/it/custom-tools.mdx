...
description: Crea strumenti che l'LLM puo chiamare in nexus.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di nexus come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.nexus/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/nexus/tools/`.
