---
title: Deling
description: Del dine NEXUS-samtaler.
---

Delingsfunksjonen i NEXUS lar deg lage offentlige lenker til dine NEXUS-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
NEXUS støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker NEXUS manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `nexus.json` i prosjektet ditt og sjekk det inn i Git.
...
[Finn ut mer](/docs/enterprise) om bruk av nexus i organisasjonen din.
