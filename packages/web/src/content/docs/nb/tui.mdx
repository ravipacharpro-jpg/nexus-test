---
title: TUI
description: Bruke nexus-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

NEXUS gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre NEXUS starter TUI for gjeldende katalog.
...
Når du bruker NEXUS TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til NEXUS. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt NEXUS. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `nexus.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge NEXUS venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `nexus.default`.
