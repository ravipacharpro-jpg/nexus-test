...
Możesz zdefiniować polecenia w `nexus.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji nexus:
...
- Globalnie: `~/.config/nexus/commands/`
- Na projekt: `.nexus/commands/`
...
nexus zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
