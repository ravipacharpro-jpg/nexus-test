---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala nexus.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

nexus zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie nexus uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI nexus, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do nexus. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `nexus.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo NEXUS czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `nexus.default`.
