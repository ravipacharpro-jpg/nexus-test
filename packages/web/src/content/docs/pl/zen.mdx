---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez NEXUS.
---
...
NEXUS Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół NEXUS.

Zen działa jak każdy inny dostawca w NEXUS. Logujesz się do NEXUS Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z NEXUS.
:::
...
NEXUS Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

NEXUS Zen działa jak każdy inny dostawca w NEXUS.

1. Logujesz się do **<a href={console}>NEXUS Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz NEXUS Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji NEXUS używa formatu
`nexus/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`nexus/gpt-5.5`.
...
W historii użycia możesz zauważyć [niedrogie modele](/docs/config/#models), takie jak Haiku, Nano lub Flash. NEXUS używa tych modeli do generowania tytułów sesji.
...
- MiMo-V2.5 Free jest dostępny w NEXUS przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Hy3 Free jest dostępny w NEXUS przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w NEXUS przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3.5 Lightning Free jest dostępny w NEXUS przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w NEXUS przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Ox Alpha Free to stealth model, który jest darmowy w NEXUS przez ograniczony czas. Dostawca stosuje zasadę zerowego przechowywania i nie używa twoich danych do trenowania modeli.
- Muse Spark 1.2 Contributor Free jest dostępny w NEXUS przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w NEXUS także dowolnego innego dostawcy.
