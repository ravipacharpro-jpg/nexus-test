...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ NEXUS:
...
- ระดับผู้ใช้ (Global): `~/.config/nexus/commands/`
- ระดับโปรเจ็กต์: `.nexus/commands/`
...
NEXUS มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
