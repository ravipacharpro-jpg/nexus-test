---
title: Özel Araçlar
description: LLM'un nexus'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. nexus'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.nexus/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/nexus/tools/` içine yerleştirerek.
