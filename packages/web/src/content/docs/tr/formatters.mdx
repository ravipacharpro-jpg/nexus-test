...
description: nexus dile özgü biçimlendiriciler kullanır.
---

nexus, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

nexus, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, nexus bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

nexus bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri nexus yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
