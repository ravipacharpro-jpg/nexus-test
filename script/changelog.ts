...
Generates UPCOMING_CHANGELOG.md by running the nexus changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for nexus run (default: low)
      --quiet            Suppress nexus command output unless it fails
